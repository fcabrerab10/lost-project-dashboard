...
const LostProjectDashboard = () => {
      ...
      <div>
          ...
          return (
            <div style={{ ...cardStyle, marginTop: '14px', background: 'rgba(255,255,255,0.02)', borderColor: 'rgba(255,255,255,0.07)' }}>
              <h4 style={{ fontSize: '10px', fontWeight: '700', letterSpacing: '0.1em', textTransform: 'uppercase', color: colors.t2, marginBottom: '12px', display: 'flex', alignItems: 'center' }}>
                <span style={{ color: colors.cyan, marginRight: '8px' }}>—</span>Conclusión del negocio
              </h4>
        ...
        <div style={{ ...cardStyle, marginTop: '12px' }}>
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '14px' }}>
            <h3 style={{ fontSize: '16px', fontWeight: '700', marginBottom: '0' }}>Pendientes del día</h3>
            ...
            <div style={{ ...cardStyle, marginTop: '12px' }}>
              <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '16px' }}>
                <h4 style={{ fontSize: '10px', fontWeight: '700', letterSpacing: '0.1em', textTransform: 'uppercase', color: colors.t2, marginBottom: '0', display: 'flex', alignItems: 'center' }}>
                  <span style={{ color: colors.cyan, marginRight: '8px' }}>—</span>Compras · Resumen
                </h4>
                <button onClick={() => setActiveTab('compras')} style={{ ...buttonStyle(), fontSize: '11px', padding: '4px 12px' }}>Ver todo →</button>
              </div>
              <div style={{ display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: '10px' }}>
                <div style={{ background: 'rgba(59,130,246,0.08)', border: '1px solid rgba(59,130,246,0.18)', borderRadius: '8px', padding: '14px', textAlign: 'center' }}>
                  <div style={{ fontSize: '9px', fontWeight: '700', letterSpacing: '0.1em', textTransform: 'uppercase', color: colors.blue, marginBottom: '6px' }}>En tránsito</div>
                ...
                <div style={{ background: 'rgba(239,68,68,0.08)', border: '1px solid rgba(239,68,68,0.18)', borderRadius: '8px', padding: '14px', textAlign: 'center' }}>
                  <div style={{ fontSize: '9px', fontWeight: '700', letterSpacing: '0.1em', textTransform: 'uppercase', color: colors.red, marginBottom: '6px' }}>Stock crítico</div>
                  <div style={{ fontSize: '24px', fontWeight: '700', color: colors.red }}>{stockCritico}</div>
                  <div style={{ fontSize: '10px', color: colors.t2, marginTop: '3px' }}>productos ≤2 uds</div>
                </div>
        ...
        {/* ── Preview: Marketing · Meta Ads ── */}
        <div style={{ ...cardStyle, marginTop: '12px' }}>
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '16px' }}>
            <h4 style={{ fontSize: '10px', fontWeight: '700', letterSpacing: '0.1em', textTransform: 'uppercase', color: colors.t2, marginBottom: '0', display: 'flex', alignItems: 'center' }}>
              <span style={{ color: colors.cyan, marginRight: '8px' }}>—</span>Marketing · Meta Ads
            </h4>
            <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
              <span style={{ fontSize: '9px', fontWeight: '700', padding: '2px 7px', borderRadius: '3px', background: 'rgba(59,130,246,0.12)', color: '#60a5fa', border: '1px solid rgba(59,130,246,0.25)', letterSpacing: '0.06em' }}>PENDIENTE CONEXIÓN</span>
              <button onClick={() => setActiveTab('marketing')} style={{ ...buttonStyle(), fontSize: '11px', padding: '4px 12px' }}>Ver todo →</button>
            </div>
          </div>
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: '10px' }}>
            <div style={{ background: 'rgba(59,130,246,0.06)', border: '1px solid rgba(59,130,246,0.15)', borderRadius: '8px', padding: '14px', textAlign: 'center' }}>
              ...
              <div style={{ fontSize: '22px', fontWeight: '700', color: colors.t1 }}>{(() => { const adsNow = recurrentes.filter(g => g.mes === new Date().getMonth() && g.concepto === 'Inversión Meta Ads').reduce((a, g) => a + g.monto, 0); return adsNow > 0 ? formatMXN(adsNow) : '—'; })()}</div>
            ...
            <div style={{ background: 'rgba(34,197,94,0.06)', border: '1px solid rgba(34,197,94,0.15)', borderRadius: '8px', padding: '14px', textAlign: 'center' }}>
              ...
              <div style={{ fontSize: '22px', fontWeight: '700', color: colors.t1 }}>—</div>
            ...
            <div style={{ background: 'rgba(168,85,247,0.06)', border: '1px solid rgba(168,85,247,0.15)', borderRadius: '8px', padding: '14px', textAlign: 'center' }}>
              <div style={{ fontSize: '9px', fontWeight: '700', letterSpacing: '0.1em', textTransform: 'uppercase', color: colors.purple, marginBottom: '6px' }}>Campañas</div>
        ...
        {/* ── Preview: Objetivos — suavizado + redistribución ── */}
        {(() => {
          // Calcular déficit acumulado de meses pasados y redistribuir en meses futuros
          ...
          return (
            <div style={{ ...cardStyle, marginTop: '12px' }}>
              <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '16px' }}>
                <h4 style={{ fontSize: '10px', fontWeight: '700', letterSpacing: '0.1em', textTransform: 'uppercase', color: colors.t2, marginBottom: '0', display: 'flex', alignItems: 'center' }}>
                  <span style={{ color: colors.cyan, marginRight: '8px' }}>—</span>Objetivos mensuales 2026
                </h4>
                <button onClick={() => setActiveTab('objetivos')} style={{ ...buttonStyle(), fontSize: '11px', padding: '4px 12px' }}>Ver todo →</button>
              </div>
                    ...
                    <div key={idx} style={{
                      ...
                      {esPasado ? (
                        <>
                          ...
                          <div style={{ fontSize: '10px', color: colors.t3 }}>cerrado · {pctObj}%</div>
                        </>
                      ) : esActual ? (
                        <>
              ...
              <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginTop: '12px', padding: '10px 14px', background: 'rgba(240,180,41,0.06)', border: '1px solid rgba(240,180,41,0.15)', borderRadius: '8px' }}>
                ...
                {deficitAcum > 0 ? (
                  ...
                  <span style={{ fontSize: '11px', fontWeight: '600', color: colors.green }}>En camino ✓</span>
                )}
              </div>
            </div>
          );
        ...
        {/* ── Preview: Forecast · Qué comprar ── */}
        <div style={{ ...cardStyle, marginTop: '12px' }}>
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '16px' }}>
            <h4 style={{ fontSize: '10px', fontWeight: '700', letterSpacing: '0.1em', textTransform: 'uppercase', color: colors.t2, marginBottom: '0', display: 'flex', alignItems: 'center' }}>
              <span style={{ color: colors.cyan, marginRight: '8px' }}>—</span>Forecast · Qué comprar
            </h4>
            <button onClick={() => setActiveTab('forecast')} style={{ ...buttonStyle(), fontSize: '11px', padding: '4px 12px' }}>Ver todo →</button>
          </div>
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr 1fr', gap: '10px' }}>
          ...
          {CATALOG.filter(p => p.stock <= 2).length > 3 && (
            <div style={{ textAlign: 'center', marginTop: '10px', fontSize: '11px', color: colors.t3 }}>
              +{CATALOG.filter(p => p.stock <= 2).length - 3} productos más requieren reposición
            </div>
          )}
        </div>

        {/* Sugerencias de acción — con rotación */}
        {(() => {
          const allSugerencias = [
            { icon: '📸', title: 'Contenido en redes', desc: 'Sube stories o reels de productos nuevos para mantener engagement con tu audiencia.' },
            { icon: '📦', title: 'Revisar inventario', desc: 'Verifica stock bajo y programa reposición antes de que se agote lo más vendido.' },
            { icon: '💬', title: 'Seguimiento clientes', desc: 'Contacta compradores recientes para pedir reseñas, referidos o feedback.' },
            { icon: '📊', title: 'Analizar métricas', desc: 'Revisa qué productos tienen mejor margen y enfoca la promoción en ellos.' },
            { icon: '🎯', title: 'Actualizar objetivos', desc: 'Ajusta los objetivos del mes según el rendimiento actual y la tendencia.' },
            { icon: '🛍️', title: 'Lanzar promo', desc: 'Crea una oferta para productos con stock alto o baja rotación para liberar capital.' },
            { icon: '🤝', title: 'Alianzas locales', desc: 'Busca colaboraciones con cafeterías, barberías o gyms para cross-promotion.' },
            { icon: '📧', title: 'Email marketing', desc: 'Envía un correo a clientes con nuevos drops o descuento exclusivo para recompra.' },
            { icon: '🏷️', title: 'Actualizar precios', desc: 'Revisa precios vs competencia y ajusta para maximizar margen sin perder ventas.' },
            { icon: '📱', title: 'Optimizar web', desc: 'Revisa la velocidad de tu tienda Shopify y mejora fotos de productos.' },
            { icon: '🎥', title: 'Grabar unboxing', desc: 'Haz un video de unboxing de productos nuevos — genera expectativa y FOMO.' },
            { icon: '⭐', title: 'Pedir reseñas', desc: 'Contacta a tus últimos 10 compradores y pídeles una reseña en Google o IG.' },
            { icon: '🧹', title: 'Limpiar catálogo', desc: 'Elimina productos sin movimiento en 60+ días o baja el precio para liquidar.' },
            { icon: '📋', title: 'Planear el mes', desc: 'Define las 3 prioridades del mes: qué vender, qué comprar, qué promover.' },
            { icon: '🔥', title: 'Drop semanal', desc: 'Programa un lanzamiento semanal de producto para mantener tráfico constante.' },
            { icon: '💰', title: 'Revisar gastos', desc: 'Busca suscripciones o gastos que puedas reducir este mes.' },
            { icon: '🎁', title: 'Programa de lealtad', desc: 'Diseña un sistema simple de puntos o descuento por recompra para clientes frecuentes.' },
            { icon: '📍', title: 'Google My Business', desc: 'Actualiza tu perfil de Google Maps con fotos nuevas y horario correcto.' },
            { icon: '🧪', title: 'A/B test en ads', desc: 'Prepara dos versiones de un anuncio y prueba cuál convierte mejor.' },
            { icon: '👥', title: 'Capacitar equipo', desc: 'Comparte técnicas de venta o producto del mes con tu equipo de tienda.' },
            { icon: '📐', title: 'Mejorar displays', desc: 'Reorganiza el layout de la tienda física para destacar los productos estrella.' },
            { icon: '🔄', title: 'Revisar devoluciones', desc: 'Analiza las devoluciones del mes — ¿hay un patrón? ¿Tallas? ¿Expectativas?' },
            { icon: '🌐', title: 'SEO básico', desc: 'Revisa títulos y descripciones de productos en Shopify para mejorar búsqueda orgánica.' },
            { icon: '📞', title: 'WhatsApp Business', desc: 'Configura respuestas rápidas y catálogo en WhatsApp para cerrar ventas más rápido.' },
            { icon: '🧲', title: 'Lead magnet', desc: 'Crea un descuento de bienvenida (10%) a cambio del email para construir tu lista.' },
            { icon: '🗓️', title: 'Calendario de contenido', desc: 'Planea las publicaciones de la semana: 3 feed, 5 stories, 2 reels mínimo.' },
            { icon: '🏪', title: 'Visual merchandising', desc: 'Cambia el escaparate de la tienda o la imagen principal de tu web cada 2 semanas.' },
            { icon: '📈', title: 'Revisar conversión web', desc: 'Entra a Shopify Analytics y revisa tu tasa de conversión — meta: >2%.' },
            { icon: '🎙️', title: 'Colaborar con influencer', desc: 'Contacta micro-influencers locales (1K-10K) para gifting o collab pagada.' },
            { icon: '🔔', title: 'Notificaciones push', desc: 'Configura alertas de back-in-stock y carritos abandonados en Shopify.' },
            { icon: '🧾', title: 'Revisar proveedores', desc: 'Pide cotización a un nuevo proveedor para comparar precios y tiempos de entrega.' },
            { icon: '🎨', title: 'Branding refresh', desc: 'Actualiza banners, highlights de IG y packaging para mantener la marca fresca.' },
            { icon: '📦', title: 'Preparar pre-orders', desc: 'Abre preventa de productos que están por llegar para asegurar ventas anticipadas.' },
            { icon: '🔍', title: 'Espiar competencia', desc: 'Revisa qué están vendiendo, a qué precio y qué promos tienen tus competidores.' },
            { icon: '💳', title: 'Revisar comisiones', desc: 'Verifica cuánto pagas en comisiones de Clip, Shopify y pasarelas — busca reducirlas.' },
            { icon: '🤳', title: 'UGC (contenido de usuarios)', desc: 'Reposta fotos de clientes usando tus productos — prueba social gratuita.' },
            { icon: '📚', title: 'Educar al cliente', desc: 'Crea un post o story explicando cómo cuidar los tenis o la ropa que vendes.' },
            { icon: '🏆', title: 'Giveaway', desc: 'Organiza un sorteo en Instagram: sigue + comenta + comparte = alcance orgánico gratis.' },
            { icon: '🛒', title: 'Recuperar carritos', desc: 'Revisa carritos abandonados en Shopify y manda mensaje personalizado por WhatsApp.' },
            { icon: '📝', title: 'Actualizar descripciones', desc: 'Mejora las descripciones de tus 5 productos más vendidos con beneficios claros.' },
            { icon: '🤖', title: 'Automatizar respuestas', desc: 'Configura respuestas automáticas en IG DMs para preguntas frecuentes (precio, tallas).' },
            { icon: '👟', title: 'Lookbook de temporada', desc: 'Arma outfits completos con tus productos y publícalos como guía de estilo.' },
            { icon: '💡', title: 'Testear nuevo producto', desc: 'Compra 3 unidades de algo nuevo y prueba la demanda antes de invertir fuerte.' },
            { icon: '🗺️', title: 'Expandir canales', desc: 'Evalúa vender en Mercado Libre, Amazon o Facebook Marketplace como canal extra.' },
            { icon: '📊', title: 'Reportar semana', desc: 'Haz un resumen rápido de ventas, gastos y pendientes de la semana para tu equipo.' },
            { icon: '🧰', title: 'Mantenimiento Shopify', desc: 'Revisa apps instaladas, elimina las que no uses y actualiza las que sí.' },
            { icon: '🎶', title: 'Playlist de tienda', desc: 'Actualiza la música de la tienda física — el ambiente vende.' },
            { icon: '📮', title: 'Packaging premium', desc: 'Agrega una tarjeta de agradecimiento o sticker a los pedidos — detalle memorable.' },
            { icon: '🔗', title: 'Link in bio', desc: 'Actualiza tu Linktree o link en bio con los productos más nuevos y promos activas.' },
            { icon: '💬', title: 'Encuesta a clientes', desc: 'Lanza una encuesta rápida en stories: ¿qué marca quieren ver? ¿Qué talla falta?' },
            { icon: '🧮', title: 'Calcular break-even', desc: 'Revisa cuánto necesitas vender este mes para cubrir todos los gastos fijos.' },
            { icon: '🚚', title: 'Revisar envíos', desc: 'Compara tarifas de paqueterías y negocia mejores precios si envías +50 paquetes/mes.' },
            { icon: '📌', title: 'Pinterest Business', desc: 'Sube fotos de productos a Pinterest — tráfico orgánico gratuito a largo plazo.' },
            { icon: '🛡️', title: 'Revisar políticas', desc: 'Actualiza políticas de devolución, cambio y envío en tu tienda Shopify.' },
            { icon: '🎓', title: 'Aprender algo nuevo', desc: 'Toma un curso corto de marketing digital, fotografía de producto o Meta Ads.' },
            { icon: '📆', title: 'Planear eventos', desc: 'Organiza un evento en tienda: lanzamiento, venta nocturna o meet & greet.' },
            { icon: '🏅', title: 'Destacar bestsellers', desc: 'Crea una colección "Lo más vendido" en Shopify y dale visibilidad en tu home.' },
            { icon: '💎', title: 'Venta privada', desc: 'Manda acceso anticipado a una promo solo para clientes VIP o tu lista de emails.' },
            { icon: '🌱', title: 'Sustentabilidad', desc: 'Comunica prácticas sustentables de tus marcas — cada vez más clientes lo valoran.' },
          ];
          ...
          return (
            <div style={{ ...cardStyle, marginTop: '12px', background: 'rgba(255,255,255,0.01)', borderColor: 'rgba(255,255,255,0.06)' }}>
              <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '16px' }}>
                <h4 style={{ fontSize: '10px', fontWeight: '700', letterSpacing: '0.1em', textTransform: 'uppercase', color: colors.t2, marginBottom: '0', display: 'flex', alignItems: 'center' }}>
                  <span style={{ color: colors.cyan, marginRight: '8px' }}>—</span>Siempre hay algo que hacer
                </h4>
                <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
  ...
  const VentasSection = () => {
    ...
    const canalData = [
      { name: 'Tienda física (POS)', value: 91, color: colors.gold },
        ...
        {year2026View ? (
          <div>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: '10px', marginBottom: '12px' }}>
              ...
              <StatCard label="Pedidos totales" value={pedidos26.toString()} note="Órdenes procesadas" color={colors.blue} />
            ...
            <div style={cardStyle}>
              <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '12px' }}>
                <h4 style={{ fontSize: '10px', fontWeight: '700', letterSpacing: '0.1em', textTransform: 'uppercase', color: colors.t2, marginBottom: '0', display: 'flex', alignItems: 'center' }}>
                  <span style={{ color: colors.cyan, marginRight: '8px' }}>—</span>Comparación 2026 vs 2025
                </h4>
            ...
            <div style={{ marginTop: '20px', marginBottom: '16px' }}>
              <div style={{ fontSize: '10px', fontWeight: '700', letterSpacing: '0.14em', textTransform: 'uppercase', color: colors.cyan, marginBottom: '4px' }}>— MES CORRIENTE</div>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: '10px', marginBottom: '12px' }}>
              ...
              <StatCard label="Ticket promedio mes" value={pedidosMes > 0 ? formatMXN(ventaMes / pedidosMes) : '—'} note="Valor por orden" color={colors.purple} />
              <StatCard label="Avance vs meta" value={META_DEF[mes] > 0 ? Math.round((ventaMes / META_DEF[mes]) * 100) + '%' : '—'} note={`Meta: ${formatMXN(META_DEF[mes])}`} color={ventaMes >= META_DEF[mes] * 0.8 ? colors.green : colors.orange} />
            </div>

            {/* Canal de ventas + Método de pago — con leyendas */}
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '12px', marginTop: '12px' }}>
              ...
              <div style={cardStyle}>
                <h4 style={{ fontSize: '10px', fontWeight: '700', letterSpacing: '0.1em', textTransform: 'uppercase', color: colors.t2, marginBottom: '14px', display: 'flex', alignItems: 'center' }}>
                  <span style={{ color: colors.cyan, marginRight: '8px' }}>—</span>Canal de ventas
                </h4>
              ...
              <div style={cardStyle}>
                <h4 style={{ fontSize: '10px', fontWeight: '700', letterSpacing: '0.1em', textTransform: 'uppercase', color: colors.t2, marginBottom: '14px', display: 'flex', alignItems: 'center' }}>
                  <span style={{ color: colors.cyan, marginRight: '8px' }}>—</span>Método de pago
                </h4>
                <div style={{ display: 'flex', gap: '16px', alignItems: 'center' }}>
                  <ResponsiveContainer width="45%" height={160}>
                    <PieChart>
            ...
            <div style={{ ...cardStyle, marginTop: '12px' }}>
              <h4 style={{ fontSize: '10px', fontWeight: '700', letterSpacing: '0.1em', textTransform: 'uppercase', color: colors.t2, marginBottom: '12px', display: 'flex', alignItems: 'center' }}>
                <span style={{ color: colors.cyan, marginRight: '8px' }}>—</span>Mejores productos
              </h4>
            ...
            <div style={{ ...cardStyle, marginTop: '12px' }}>
              <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '14px' }}>
                <h4 style={{ fontSize: '10px', fontWeight: '700', letterSpacing: '0.1em', textTransform: 'uppercase', color: colors.t2, marginBottom: '0', display: 'flex', alignItems: 'center' }}>
                  <span style={{ color: colors.cyan, marginRight: '8px' }}>—</span>Últimos pedidos
                </h4>
                <span style={{ fontSize: '10px', color: colors.t3 }}>{DEMO_ORDERS.length} órdenes recientes</span>
              </div>
              <div style={{ overflowX: 'auto' }}>
                <table style={tableStyle}>
                  <thead>
                  ...
                  <tbody>
                    {DEMO_ORDERS.map((order) => {
                      const estadoMap = {
                        ...
                        'En tránsito': { bg: 'rgba(59,130,246,0.15)', color: colors.blue, border: 'rgba(59,130,246,0.2)' },
              ...
              <div style={{ marginTop: '12px', paddingTop: '12px', borderTop: `1px solid ${colors.br}`, fontSize: '11px', color: colors.t3, textAlign: 'center' }}>
                Los datos en tiempo real requieren conexión a Shopify Live
              </div>
            </div>
          </div>
        ) : (
          <div>
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: '10px', marginBottom: '12px' }}>
              ...
              <StatCard label="Artículos vendidos" value="1,452" note="Unidades netas" color={colors.teal} />
              <StatCard label="Ticket promedio" value={formatMXN(ytd25 / pedidos25)} note="Por pedido" color={colors.purple} />
            </div>

            <div style={cardStyle}>
              <h4 style={{ fontSize: '10px', fontWeight: '700', letterSpacing: '0.1em', textTransform: 'uppercase', color: colors.t2, marginBottom: '12px', display: 'flex', alignItems: 'center' }}>
                <span style={{ color: colors.cyan, marginRight: '8px' }}>—</span>Ventas mensuales 2025
              </h4>
  ...
  const GastosSection = () => {
    ...
    // Comisión Ana Sofía = 10% sobre utilidad después de gastos (solo si es positiva)
    ...
    // Evolución de gastos por mes (línea)
    ...
    // Comisiones Ana Sofía — registro mensual
    ...
    return (
      <div>
        <SectionTitle sub="Costos operativos del negocio · fijos y variables">Gastos</SectionTitle>
        ...
        <div style={{ ...cardStyle, padding: '20px 24px' }}>
          <h3 style={{ fontSize: '16px', fontWeight: '700', marginBottom: '16px' }}>¿Cuánto queda después de gastos?</h3>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr 1fr', gap: '0', border: '1px solid rgba(255,255,255,0.08)', borderRadius: '12px', overflow: 'hidden' }}>
            ...
            <div style={{ padding: '16px', background: 'rgba(255,255,255,0.03)', textAlign: 'center', borderRight: '0.5px solid rgba(255,255,255,0.08)' }}>
              <div style={{ fontSize: '11px', fontWeight: '600', letterSpacing: '0.08em', textTransform: 'uppercase', color: colors.t2, marginBottom: '8px' }}>Costo mercancía (~70%)</div>
          ...
          {/* Barra de distribución — 4 segmentos */}
          <div style={{ marginTop: '14px' }}>
            ...
            <div style={{ display: 'flex', gap: '14px', marginTop: '8px', fontSize: '11px', color: colors.t2, flexWrap: 'wrap' }}>
              ...
              <span><span style={{ display: 'inline-block', width: '10px', height: '10px', background: colors.purple, borderRadius: '2px', marginRight: '4px', verticalAlign: 'middle' }} />Comisión</span>
        ...
        <div style={{ ...cardStyle, marginTop: '12px' }}>
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '16px' }}>
            ...
            <button style={buttonStyle('gold')}>+ Agregar</button>
          </div>
          <div style={{ overflowX: 'auto' }}>
            <table style={tableStyle}>
              <thead>
              ...
              <tbody>
                {fixedExpenses.map((exp, idx) => (
                  <tr key={idx}>
                    ...
                    <td style={tdStyle}>
                      <button style={buttonStyle()} onClick={() => {}}>Editar</button>
                    </td>
                  </tr>
                ))}
        ...
        {/* ═══ COMISIONES ANA SOFÍA ═══ */}
        <div style={{ ...cardStyle, marginTop: '12px', borderLeft: `3px solid ${colors.purple}` }}>
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: '16px' }}>
            <div>
              <h3 style={{ fontSize: '16px', fontWeight: '700', marginBottom: '4px' }}>Comisiones Ana Sofía</h3>
              <div style={{ fontSize: '12px', color: colors.t2 }}>10% sobre utilidades después de gastos</div>
            </div>
          ...
          <div style={{ padding: '14px 18px', background: 'rgba(168,85,247,0.06)', border: '1px solid rgba(168,85,247,0.15)', borderRadius: '10px', marginBottom: '16px' }}>
            <div style={{ fontSize: '10px', fontWeight: '700', letterSpacing: '0.1em', textTransform: 'uppercase', color: colors.purple, marginBottom: '10px' }}>Calculadora — {MESES_FULL[mes]}</div>
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr 1fr 1fr', gap: '12px' }}>
              ...
              <div>
                <div style={{ fontSize: '11px', color: colors.t2, marginBottom: '3px' }}>− Costo (70%)</div>
                <div style={{ fontSize: '15px', fontWeight: '600', color: colors.orange }}>−{formatMXN(costoMercancia)}</div>
              </div>
              <div>
                <div style={{ fontSize: '11px', color: colors.t2, marginBottom: '3px' }}>− Gastos op.</div>
                <div style={{ fontSize: '15px', fontWeight: '600', color: colors.red }}>−{formatMXN(totalMes)}</div>
              </div>
              <div>
            ...
            <div style={{ marginTop: '10px', paddingTop: '10px', borderTop: '1px solid rgba(168,85,247,0.15)', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
              <span style={{ fontSize: '13px', color: colors.t2 }}>Comisión 10% = {formatMXN(gananciaPostGastos)} × 0.10</span>
            ...
            <table style={tableStyle}>
              <thead>
                <tr>
                  ...
                  <th style={{ ...thStyle, textAlign: 'right' }}>Comisión (10%)</th>
                </tr>
              </thead>
              <tbody>
        ...
        <div style={{ ...cardStyle, marginTop: '12px' }}>
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '4px' }}>
            <h4 style={{ fontSize: '14px', fontWeight: '700', marginBottom: '0' }}>Evolución de gastos — 2026</h4>
            <div style={{ display: 'flex', gap: '14px', fontSize: '10px' }}>
        ...
        {/* ═══ GASTOS VARIABLES RECURRENTES (Ads + Clip) ═══ */}
        <div style={{ ...cardStyle, marginTop: '12px' }}>
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '16px' }}>
            <div>
              <h3 style={{ fontSize: '16px', fontWeight: '700', marginBottom: '4px' }}>Variables recurrentes</h3>
              <div style={{ fontSize: '12px', color: colors.t2 }}>Inversión en Ads y comisión de Clip — haz clic en un monto para editarlo</div>
            </div>
          </div>
          <div style={{ overflowX: 'auto' }}>
            <table style={tableStyle}>
              ...
              <tbody>
                {['Inversión Meta Ads', 'Comisión Clip'].map((concepto, ci) => {
                ...
                <tr style={{ borderTop: '0.5px solid rgba(255,255,255,0.1)' }}>
                  ...
                  {MESES.slice(0, mes + 1).map((m, idx) => {
                    ...
                    return <td key={idx} style={{ ...tdStyle, textAlign: 'right', fontWeight: '600', color: colors.orange }}>{tot > 0 ? formatMXN(tot) : '—'}</td>;
                  })}
        ...
        <div style={{ ...cardStyle, marginTop: '12px' }}>
          ...
          {gastosDiarios.length > 0 ? (
            ...
            <div style={{ padding: '32px', textAlign: 'center', border: '1px dashed rgba(255,255,255,0.1)', borderRadius: '10px' }}>
              ...
              <div style={{ fontSize: '11px', color: 'rgba(255,255,255,0.3)' }}>Los gastos que vayas registrando aparecerán aquí</div>
            </div>
          )}
        </div>
      </div>
  ...
  const ComprasSection = () => {
    ...
    // KPIs calculados
    const enTransito = comprasActivas.filter(c => c.estado === 'En tránsito').length;
    ...
    const ESTADOS_COMPRA = ['Pedido', 'Pagado', 'En tránsito', 'En aduana', 'Entregado'];
    const estadoColors = {
      ...
      'En tránsito': { bg: 'rgba(0,200,224,0.12)', color: colors.cyan, border: 'rgba(0,200,224,0.2)' },
    ...
    return (
      <div>
        <SectionTitle sub="Estado del inventario · pedidos a proveedores · tránsito">Compras</SectionTitle>

        {/* ═══ KPIs ═══ */}
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: '10px', marginBottom: '12px' }}>
          <StatCard label="En tránsito" value={enTransito.toString()} note="Pedidos en camino" color={colors.blue} />
        ...
        <div style={{ ...cardStyle, marginTop: '12px' }}>
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '16px' }}>
            ...
            <button style={buttonStyle('gold')} onClick={() => setShowFormCompra(!showFormCompra)}>
              {showFormCompra ? '✕ Cerrar' : '+ Nueva compra'}
            </button>
          </div>
            ...
            <div style={{ padding: '16px', background: colors.bg1, borderRadius: '10px', border: `1px solid ${colors.br}`, marginBottom: '16px' }}>
              ...
              <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr 1fr 1fr 1fr', gap: '10px', marginBottom: '10px' }}>
                ...
                <div>
                  ...
                  <input style={inputStyle} placeholder="Descripción" value={newCompra.productos} onChange={(e) => setNewCompra({ ...newCompra, productos: e.target.value })} />
                </div>
                <div>
              ...
              <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr 1fr 1fr', gap: '10px', marginBottom: '12px' }}>
                ...
                <div>
                  <label style={labelStyle}># Guía</label>
                  <input style={inputStyle} placeholder="Número de rastreo" value={newCompra.guia} onChange={(e) => setNewCompra({ ...newCompra, guia: e.target.value })} />
                </div>
                <div>
          ...
          {comprasActivas.length > 0 ? (
                ...
                <tbody>
                  {comprasActivas.map((c, idx) => (
                    <tr key={idx}>
                      ...
                      <td style={tdStyle}>{c.numPedido || '—'}</td>
                      <td style={tdStyle}>{c.paqueteria || '—'}</td>
                      <td style={{ ...tdStyle, fontSize: '11px', fontFamily: 'monospace' }}>{c.guia || '—'}</td>
                      <td style={tdStyle}>
                        <select
                          value={c.estado}
                      ...
                      <td style={{ ...tdStyle, fontSize: '12px', maxWidth: '120px', overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap' }}>{c.comentarios || '—'}</td>
                      <td style={tdStyle}>
                        <button style={{ ...buttonStyle(), fontSize: '10px', padding: '3px 8px' }} onClick={() => marcarEntregado(idx)}>✓ Recibido</button>
                      </td>
                    </tr>
                  ))}
                </tbody>
            ...
            <div style={{ padding: '32px', textAlign: 'center', border: '1px dashed rgba(255,255,255,0.1)', borderRadius: '10px' }}>
              ...
              <div style={{ fontSize: '11px', color: 'rgba(255,255,255,0.3)' }}>Registra una nueva compra con el botón de arriba</div>
            </div>
          )}
        </div>
        ...
        <div style={{ ...cardStyle, marginTop: '12px' }}>
          <h3 style={{ fontSize: '16px', fontWeight: '700', marginBottom: '16px' }}>Historial — entregas recibidas</h3>
          {comprasHistorial.length > 0 ? (
                ...
                <tbody>
                  {comprasHistorial.map((c, idx) => (
                    <tr key={idx}>
                      ...
                      <td style={{ ...tdStyle, fontSize: '12px' }}>{c.comentarios || '—'}</td>
                    </tr>
                  ))}
                </tbody>
              </table>
            ...
            <div style={{ padding: '24px', textAlign: 'center', color: colors.t2, fontSize: '13px' }}>Sin historial aún.</div>
          )}
        </div>
        ...
        <div style={{ ...cardStyle, marginTop: '12px' }}>
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '16px' }}>
            ...
            <button style={buttonStyle('gold')} onClick={() => setShowFormProv(!showFormProv)}>
              {showFormProv ? '✕ Cerrar' : '+ Agregar proveedor'}
            </button>
          </div>
            ...
            <div style={{ padding: '16px', background: colors.bg1, borderRadius: '10px', border: `1px solid ${colors.br}`, marginBottom: '16px' }}>
              ...
              <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr 1fr 1fr', gap: '10px', marginBottom: '10px' }}>
                ...
                <div>
                  ...
                  <input style={inputStyle} placeholder="Nombre o número" value={newProv.contacto} onChange={(e) => setNewProv({ ...newProv, contacto: e.target.value })} />
                </div>
                <div>
                  <label style={labelStyle}>Tiempo de entrega</label>
                  <input style={inputStyle} placeholder="Ej: 5-7 días" value={newProv.tiempoEntrega} onChange={(e) => setNewProv({ ...newProv, tiempoEntrega: e.target.value })} />
                </div>
              </div>
              ...
              {proveedores.map((p, idx) => (
                <div key={idx} style={{ padding: '14px 18px', background: colors.bg1, borderRadius: '10px', border: `1px solid ${colors.br}` }}>
                  <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: '8px' }}>
                    ...
                    <button style={{ ...buttonStyle(), fontSize: '10px', padding: '2px 8px' }} onClick={() => setProveedores(prev => prev.filter((_, i) => i !== idx))}>✕</button>
                  </div>
                  {p.sitioWeb && <div style={{ fontSize: '12px', color: colors.cyan, marginBottom: '4px', overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap' }}>🌐 {p.sitioWeb}</div>}
                  {p.contacto && <div style={{ fontSize: '12px', color: colors.t2, marginBottom: '4px' }}>💬 {p.contacto}</div>}
                  {p.notas && <div style={{ fontSize: '11px', color: colors.t2, marginBottom: '4px', opacity: 0.7 }}>{p.notas}</div>}
                  <div style={{ display: 'flex', gap: '8px', marginTop: '8px', flexWrap: 'wrap' }}>
                    {p.tiempoEntrega && <span style={{ fontSize: '10px', padding: '2px 8px', borderRadius: '4px', background: 'rgba(0,200,224,0.1)', color: colors.cyan, border: '1px solid rgba(0,200,224,0.2)' }}>⏱ {p.tiempoEntrega}</span>}
                    {p.condiciones && <span style={{ fontSize: '10px', padding: '2px 8px', borderRadius: '4px', background: 'rgba(240,180,41,0.1)', color: colors.gold, border: '1px solid rgba(240,180,41,0.2)' }}>💳 {p.condiciones}</span>}
                  </div>
                </div>
              ))}
            </div>
        ...
        <div style={{ ...cardStyle, marginTop: '12px' }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: '10px' }}>
            {[
              { mes: 'Enero', fecha: '2 – 15 Ene', evento: 'Farfetch Winter Sale', donde: 'Farfetch', tip: 'Sale final de invierno. Descuentos hasta 60% en diseñador y streetwear premium. Cettire también hace rebajas similares.', color: colors.cyan, icon: '❄️' },
              { mes: 'Enero', fecha: '5 – 20 Ene', evento: 'SSENSE Sale Final', donde: 'SSENSE', tip: 'Últimas reducciones de la sale de invierno. Piezas de Off-White, Balenciaga, Fear of God a 50-70% off.', color: colors.purple, icon: '🏷️' },
              { mes: 'Febrero', fecha: '14 – 17 Feb', evento: 'Presidents Day Sales US', donde: 'USA', tip: 'Nike, Foot Locker, Nordstrom — descuentos 20-40%. Buen momento para ir a outlets en McAllen, Houston o LA.', color: colors.blue, icon: '🇺🇸' },
              { mes: 'Marzo', fecha: '10 Mar – 15 Abr', evento: 'Fin de temporada FW', donde: 'Farfetch · Cettire · SSENSE', tip: 'Liquidación colección otoño-invierno en todas las plataformas. Últimas tallas y piezas únicas al mejor precio.', color: colors.green, icon: '🌱' },
              { mes: 'Mayo', fecha: '23 – 26 May', evento: 'Memorial Day Sales US', donde: 'USA', tip: 'Nike, Adidas, outlets premium con 30-50% extra. Ideal para viaje de compras a USA — abastecer antes del verano.', color: colors.teal, icon: '⭐' },
              { mes: 'Junio', fecha: '1 Jun – 15 Jul', evento: 'Summer Sale', donde: 'Farfetch · SSENSE · Cettire', tip: 'LA MEJOR ÉPOCA. SSENSE sale (hasta 70%), Farfetch mid-season, Cettire summer clearance. Comprar inventario para Q3-Q4.', color: colors.gold, icon: '☀️' },
              { mes: 'Julio', fecha: '1–4 Jul · 8–9 Jul', evento: '4th of July + Prime Day', donde: 'USA · Amazon', tip: 'Doble oportunidad: sales por Independence Day en retailers US + Amazon Prime Day para suministros y sneakers seleccionados.', color: colors.red, icon: '🔥' },
              { mes: 'Septiembre', fecha: '29 Ago – 1 Sep', evento: 'Labor Day Sales US', donde: 'USA', tip: 'Último gran sale de verano en USA. Outlets Nike, premium outlets. Stock para temporada navideña.', color: colors.orange, icon: '🛍️' },
              { mes: 'Noviembre', fecha: '14–17 Nov (MX) · 28 Nov (US)', evento: 'Buen Fin + Black Friday', donde: 'Todos', tip: 'Farfetch hasta 50%, SSENSE deals, Cettire extra discounts, Buen Fin MX, Black Friday USA. COMPRAR TODO para diciembre y Q1.', color: colors.red, icon: '🖤' },
              { mes: 'Noviembre', fecha: '1 Dic', evento: 'Cyber Monday', donde: 'Farfetch · Cettire · Online', tip: 'Extensión del Black Friday online. Farfetch y Cettire suelen extender o mejorar descuentos. Últimas oportunidades.', color: colors.pink, icon: '💻' },
              { mes: 'Diciembre', fecha: '26 – 31 Dic', evento: 'Post-Xmas + Boxing Day', donde: 'Farfetch · SSENSE · USA', tip: 'Boxing Day sale en plataformas internacionales. Liquidaciones finales. Reabastecer lo que se agotó en navidad.', color: colors.cyan, icon: '🎄' },
              { mes: 'Todo el año', fecha: 'Revisar cada semana', evento: 'Cettire everyday pricing', donde: 'Cettire', tip: 'Cettire maneja precios por debajo de retail todo el año en marcas como Balenciaga, Gucci, Prada. Revisar constantemente.', color: colors.t2, icon: '🔄' },
            ].map((f, idx) => {
              const now = new Date();
              const mesMap = { 'Enero': 0, 'Febrero': 1, 'Marzo': 2, 'Abril': 3, 'Mayo': 4, 'Junio': 5, 'Julio': 6, 'Agosto': 7, 'Septiembre': 8, 'Octubre': 9, 'Noviembre': 10, 'Diciembre': 11, 'Todo el año': -1 };
  ...
  const MarketingSection = () => {
    // Datos de Meta — cuando se conecte la API, metaConnected = true y los valores se llenarán
    ...
    const adSpendFromRecurrentes = recurrentes
      .filter(g => g.mes === mesMkt && g.concepto === 'Inversión Meta Ads')
    ...
    const campaignData = [
      { nombre: 'Campaña Verano 2026', estado: 'pausada', presupuesto: 5000, gastado: 0, impresiones: 0, clics: 0, conversiones: 0, roas: 0 },
    ...
    return (
      <div>
        ...
        <div style={{ display: 'flex', gap: '12px', padding: '14px 16px', borderRadius: '10px', fontSize: '13px', lineHeight: '1.6', marginBottom: '16px', background: metaConnected ? 'rgba(34,197,94,0.08)' : 'rgba(59,130,246,0.08)', color: metaConnected ? colors.green : '#60a5fa', border: metaConnected ? '1px solid rgba(34,197,94,0.2)' : '1px solid rgba(59,130,246,0.2)' }}>
          <span>{metaConnected ? '✓' : '⚡'}</span>
          <span>
            {metaConnected
              ? 'Conectado a Meta Business Suite — datos actualizándose en tiempo real.'
              : <>Los datos de marketing mostrados son <strong>placeholders</strong>. Conecta <strong>Meta Business Suite</strong> para ver métricas reales de Facebook Ads e Instagram en tiempo real.</>
            }
          </span>
        </div>
        ...
        {/* KPIs principales */}
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: '10px', marginBottom: '12px' }}>
          <StatCard label="Gasto en ads" value={adSpend > 0 ? formatMXN(adSpend) : '—'} note="Mes actual · sincronizado con Gastos" color={colors.blue} />
          <StatCard label="ROAS" value={roas > 0 ? roas.toFixed(1) + 'x' : '—'} note="Retorno por $1 invertido" color={colors.green} />
          <StatCard label="CPC promedio" value={cpc > 0 ? formatMXN(cpc) : '—'} note="Costo por clic" color={colors.purple} />
          <StatCard label="Conversiones" value={conversions > 0 ? conversions.toString() : '—'} note="Compras atribuidas" color={colors.gold} />
        </div>

        {/* Segunda fila de KPIs */}
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: '10px', marginBottom: '12px' }}>
          <StatCard label="Impresiones" value={impressions > 0 ? impressions.toLocaleString('es-MX') : '—'} note="Veces mostrado" color={colors.cyan} />
          <StatCard label="Alcance" value={reach > 0 ? reach.toLocaleString('es-MX') : '—'} note="Personas únicas" color={colors.teal} />
          <StatCard label="Clics" value={clicks > 0 ? clicks.toLocaleString('es-MX') : '—'} note="Clics al sitio" color={colors.orange} />
          <StatCard label="CTR" value={ctr > 0 ? ctr.toFixed(2) + '%' : '—'} note="Click-through rate" color={colors.pink} />
        </div>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '12px', marginBottom: '12px' }}>
          <div style={cardStyle}>
            <h4 style={{ fontSize: '10px', fontWeight: '700', letterSpacing: '0.1em', textTransform: 'uppercase', color: colors.t2, marginBottom: '16px', display: 'flex', alignItems: 'center' }}>
              <span style={{ color: colors.cyan, marginRight: '8px' }}>—</span>Embudo de conversión
            </h4>
            {[
              ...
              <div key={idx} style={{ marginBottom: '12px' }}>
                <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: '4px' }}>
                  ...
                  <span style={{ fontSize: '11px', fontWeight: '600', color: step.color }}>{step.value > 0 ? step.value.toLocaleString('es-MX') : '—'}</span>
                </div>
          ...
          <div style={cardStyle}>
            <h4 style={{ fontSize: '10px', fontWeight: '700', letterSpacing: '0.1em', textTransform: 'uppercase', color: colors.t2, marginBottom: '16px', display: 'flex', alignItems: 'center' }}>
              <span style={{ color: colors.cyan, marginRight: '8px' }}>—</span>Distribución de gasto
            </h4>
            <div style={{ display: 'flex', flexDirection: 'column', gap: '14px' }}>
              {[
                { plataforma: 'Instagram Ads', icon: '📷', porcentaje: 0, color: colors.pink, desc: 'Stories, Reels, Feed' },
                { plataforma: 'Facebook Ads', icon: '📘', porcentaje: 0, color: colors.blue, desc: 'Feed, Marketplace' },
                { plataforma: 'Orgánico Instagram', icon: '✨', porcentaje: 0, color: colors.purple, desc: 'Posts, Reels, Stories' },
                { plataforma: 'WhatsApp Business', icon: '💬', porcentaje: 0, color: '#25D366', desc: 'Mensajes directos' },
              ].map((p, idx) => (
                <div key={idx} style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
                  ...
                  <div style={{ flex: 1 }}>
                    <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: '4px' }}>
                      ...
                      <span style={{ fontSize: '11px', fontWeight: '600', color: p.color }}>{p.porcentaje > 0 ? p.porcentaje + '%' : '—'}</span>
                    </div>
            ...
            {!metaConnected && (
              <div style={{ textAlign: 'center', padding: '12px 0 4px', fontSize: '11px', color: colors.t3 }}>
                Sin datos — pendiente conexión a Meta
              </div>
            )}
          </div>
        </div>
        ...
        <div style={cardStyle}>
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '16px' }}>
            <h4 style={{ fontSize: '10px', fontWeight: '700', letterSpacing: '0.1em', textTransform: 'uppercase', color: colors.t2, marginBottom: '0', display: 'flex', alignItems: 'center' }}>
              <span style={{ color: colors.cyan, marginRight: '8px' }}>—</span>Campañas · Meta Ads
            </h4>
            <div style={{ display: 'flex', gap: '8px', alignItems: 'center' }}>
              <span style={{ fontSize: '10px', color: colors.t3 }}>{campaignData.length} campañas</span>
              <button style={buttonStyle('gold')}>+ Nueva campaña</button>
            </div>
          </div>
          <div style={{ overflowX: 'auto' }}>
            <table style={tableStyle}>
              ...
              <tbody>
                {campaignData.map((c, idx) => (
                  <tr key={idx}>
                    ...
                    <td style={{ ...tdStyle, textAlign: 'right' }}>{c.gastado > 0 ? formatMXN(c.gastado) : '—'}</td>
                    <td style={{ ...tdStyle, textAlign: 'right' }}>{c.impresiones > 0 ? c.impresiones.toLocaleString('es-MX') : '—'}</td>
                    <td style={{ ...tdStyle, textAlign: 'right' }}>{c.clics > 0 ? c.clics.toLocaleString('es-MX') : '—'}</td>
                    <td style={{ ...tdStyle, textAlign: 'right' }}>{c.conversiones > 0 ? c.conversiones : '—'}</td>
                    <td style={{ ...tdStyle, textAlign: 'right' }}>{c.roas > 0 ? c.roas.toFixed(1) + 'x' : '—'}</td>
                  </tr>
                ))}
              </tbody>
            </table>
        ...
        <div style={{ ...cardStyle, marginTop: '12px' }}>
          <h4 style={{ fontSize: '10px', fontWeight: '700', letterSpacing: '0.1em', textTransform: 'uppercase', color: colors.t2, marginBottom: '16px', display: 'flex', alignItems: 'center' }}>
            <span style={{ color: colors.cyan, marginRight: '8px' }}>—</span>Rendimiento orgánico · Instagram
          </h4>
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: '10px' }}>
            {[
              { label: 'Seguidores', value: '—', note: 'Total', color: colors.pink },
              { label: 'Alcance orgánico', value: '—', note: 'Últimos 30 días', color: colors.purple },
              { label: 'Interacciones', value: '—', note: 'Likes + comments', color: colors.cyan },
              { label: 'Tasa de engagement', value: '—', note: '% interacciones/alcance', color: colors.green },
            ].map((m, idx) => (
        ...
        <div style={{ ...cardStyle, marginTop: '12px', borderLeft: `3px solid ${colors.pink}` }}>
          <div style={{ marginBottom: '20px' }}>
            <h3 style={{ fontSize: '16px', fontWeight: '700', marginBottom: '4px' }}>Estrategia de contenido · Instagram</h3>
            <div style={{ fontSize: '12px', color: colors.t2 }}>Sugerencias y plan de acción para @lostproject.mx</div>
          </div>

          {/* Sugerencias para mejorar */}
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: '10px', marginBottom: '20px' }}>
            {[
              { icon: '💡', titulo: 'Seguir con Reels + humor', desc: 'Es tu mayor fortaleza. Los rankings, POVs y el tono cercano generan comunidad. Duplica la frecuencia.', color: colors.green, tag: 'Mantener' },
              { icon: '📸', titulo: 'Agregar fotos editoriales', desc: 'Complementa los Reels con fotos lifestyle de producto — alguien usándolos, no solo el par en caja.', color: colors.cyan, tag: 'Agregar' },
              { icon: '🎯', titulo: 'Organizar highlights', desc: 'Crea highlights por: Marcas, Reseñas de clientes, Tienda, Envíos, FAQ. Facilita la navegación para nuevos seguidores.', color: colors.purple, tag: 'Mejorar' },
              { icon: '🏷️', titulo: 'Marcas aspiracionales', desc: 'Muestra tus marcas premium con la misma calidad visual que las tiendas de lujo, pero con tu personalidad.', color: colors.gold, tag: 'Elevar' },
              { icon: '🤳', titulo: 'Más caras del equipo', desc: 'Fran y Mathias conectan con la audiencia. Más presencia personal = más confianza y engagement.', color: colors.pink, tag: 'Potenciar' },
              { icon: '📊', titulo: 'Carruseles educativos', desc: 'Agrega 1-2 carruseles por semana: guías de tallas, cómo identificar originales, tendencias de temporada.', color: colors.blue, tag: 'Agregar' },
            ].map((s, idx) => (
          ...
          <div style={{ fontSize: '10px', fontWeight: '700', letterSpacing: '0.1em', textTransform: 'uppercase', color: colors.pink, marginBottom: '12px' }}>Pilares de contenido — publicar 4-5 veces por semana</div>
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(2, 1fr)', gap: '10px', marginBottom: '20px' }}>
            {[
              { pilar: 'Reels de entretenimiento', freq: '2x/sem', color: colors.red, icon: '🎬', ideas: ['Rankings de pares (ya funciona — seguir)', 'POV humor sneakerhead', 'Reacciones a outfits de clientes', '"Adivina el precio" con productos de la tienda', 'Tendencias de TikTok adaptadas a sneakers'] },
              { pilar: 'Producto + Educación', freq: '1-2x/sem', color: colors.cyan, icon: '👟', ideas: ['Unboxing de drops nuevos (Farfetch, SSENSE)', 'Guía "Cómo identificar si es original"', 'Top 5 sneakers por debajo de $X', 'Historia detrás de la marca/modelo', 'Comparativa: original vs réplica'] },
              { pilar: 'Detrás de cámaras', freq: '1x/sem', color: colors.purple, icon: '📦', ideas: ['Empacando pedidos / proceso de envío', 'Viaje a USA para compras', 'Recibiendo mercancía nueva', 'Un día en la tienda de Lost Project', 'Cómo elegimos qué comprar'] },
              { pilar: 'Comunidad + Social proof', freq: '1x/sem', color: colors.gold, icon: '🤝', ideas: ['Clientes recogiendo en tienda', 'Reviews y testimonios reales', 'Encuestas y Q&A en stories', '"Este par lo eligió [cliente]" — styling', 'Memes del mundo sneaker'] },
            ].map((p, idx) => (
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(7, 1fr)', gap: '6px', marginBottom: '20px' }}>
            {[
              { dia: 'LUN', tipo: 'Reel humor', color: colors.red, icon: '🎬' },
              { dia: 'MAR', tipo: 'Stories encuesta', color: colors.gold, icon: '📊' },
              { dia: 'MIE', tipo: 'Producto / Drop', color: colors.cyan, icon: '👟' },
              { dia: 'JUE', tipo: 'Behind scenes', color: colors.purple, icon: '📦' },
              { dia: 'VIE', tipo: 'Reel trending', color: colors.red, icon: '🔥' },
              { dia: 'SAB', tipo: 'Comunidad', color: colors.gold, icon: '🤝' },
              { dia: 'DOM', tipo: 'Descanso / Stories', color: colors.t2, icon: '😴' },
            ].map((d, idx) => (
        ...
        {/* ═══ CALCULADORA DE INVERSIÓN EN ADS ═══ */}
        <div style={{ ...cardStyle, marginTop: '12px', borderLeft: `3px solid ${colors.blue}` }}>
          <div style={{ marginBottom: '16px' }}>
            <h3 style={{ fontSize: '16px', fontWeight: '700', marginBottom: '4px' }}>Calculadora de inversión en ads</h3>
            <div style={{ fontSize: '12px', color: colors.t2 }}>¿Cuánto invertir para alcanzar tu meta de ventas?</div>
          </div>
          {(() => {
            const mesActual = new Date().getMonth();
            const ventasMesActual = VENTAS_2026[mesActual];
            const adsMesActual = recurrentes.filter(g => g.mes === mesActual && g.concepto === 'Inversión Meta Ads').reduce((a, g) => a + g.monto, 0);
              ...
              <>
                <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr 1fr', gap: '10px', marginBottom: '16px' }}>
                  <div style={{ background: colors.bg1, borderRadius: '10px', border: `1px solid ${colors.br}`, padding: '16px', textAlign: 'center' }}>
                    ...
                    <div style={{ fontSize: '10px', color: colors.t2, marginTop: '4px' }}>Ajusta según tu historial</div>
                  </div>
                  <div style={{ background: colors.bg1, borderRadius: '10px', border: `1px solid ${colors.br}`, padding: '16px', textAlign: 'center' }}>
                  ...
                  <div style={{ background: colors.bg1, borderRadius: '10px', border: `1px solid ${colors.br}`, padding: '16px', textAlign: 'center' }}>
                    <div style={{ fontSize: '9px', fontWeight: '700', letterSpacing: '0.1em', textTransform: 'uppercase', color: colors.green, marginBottom: '6px' }}>Inversión necesaria</div>
                ...
                <div style={{ background: colors.bg1, borderRadius: '10px', border: `1px solid ${colors.br}`, padding: '16px' }}>
                  ...
                  {roasReal > 0 && (
                    <div style={{ textAlign: 'center', marginTop: '12px', padding: '8px', background: 'rgba(240,180,41,0.06)', borderRadius: '6px', border: '1px solid rgba(240,180,41,0.15)' }}>
                      <span style={{ fontSize: '11px', color: colors.gold }}>ROAS real este mes: <strong>{roasReal.toFixed(1)}x</strong> ({formatMXN(adsMesActual)} invertidos → {formatMXN(ventasMesActual)} vendidos)</span>
                    </div>
                  )}
                </div>
              </>
        ...
        <div style={{ ...cardStyle, marginTop: '12px', borderLeft: `3px solid ${colors.pink}` }}>
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '16px' }}>
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
              ...
              <button onClick={() => setShowFormContent(!showFormContent)} style={buttonStyle('pink')}>{showFormContent ? '✕ Cerrar' : '+ Registrar publicación'}</button>
            </div>
          </div>
          {showFormContent && (
            <div style={{ background: colors.bg1, borderRadius: '10px', border: `1px solid ${colors.br}`, padding: '16px', marginBottom: '16px' }}>
              <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr 1fr 2fr', gap: '10px', marginBottom: '12px' }}>
                <div>
                  <label style={{ fontSize: '10px', color: colors.t2, display: 'block', marginBottom: '4px' }}>Día</label>
                ...
                <div>
                  ...
                  <select value={newContent.pilar} onChange={e => setNewContent({ ...newContent, pilar: e.target.value })} style={{ width: '100%', background: colors.bg3, border: `1px solid ${colors.br}`, borderRadius: '6px', padding: '8px', color: colors.t1, fontSize: '12px' }}>
                    {['Entretenimiento', 'Producto + Educación', 'Detrás de cámaras', 'Comunidad + Social proof'].map(p => <option key={p} value={p}>{p}</option>)}
                  </select>
                </div>
                <div>
                  ...
                  <select value={newContent.formato} onChange={e => setNewContent({ ...newContent, formato: e.target.value })} style={{ width: '100%', background: colors.bg3, border: `1px solid ${colors.br}`, borderRadius: '6px', padding: '8px', color: colors.t1, fontSize: '12px' }}>
                    {['Reel', 'Carrusel', 'Historia', 'Foto', 'Colaboración'].map(f => <option key={f} value={f}>{f}</option>)}
                  </select>
                </div>
                <div>
                  <label style={{ fontSize: '10px', color: colors.t2, display: 'block', marginBottom: '4px' }}>Descripción</label>
                  <input value={newContent.descripcion} onChange={e => setNewContent({ ...newContent, descripcion: e.target.value })} placeholder="Ej: Reel ranking top 5 Jordan del año" style={{ width: '100%', background: colors.bg3, border: `1px solid ${colors.br}`, borderRadius: '6px', padding: '8px', color: colors.t1, fontSize: '12px' }} />
                </div>
              </div>
          ...
          {contentTracker.length > 0 ? (
              ...
              <table style={tableStyle}>
                ...
                <tbody>
                  {contentTracker.map((c) => {
                    const pilarColors = { 'Entretenimiento': colors.gold, 'Producto + Educación': colors.cyan, 'Detrás de cámaras': colors.purple, 'Comunidad + Social proof': colors.green };
                    const formatoColors = { 'Reel': colors.pink, 'Carrusel': colors.blue, 'Historia': colors.orange, 'Foto': colors.teal, 'Colaboración': colors.gold };
                    return (
                      <tr key={c.id}>
                        ...
                        <td style={{ ...tdStyle, textAlign: 'center' }}>
                          <button onClick={() => setContentTracker(prev => prev.filter(p => p.id !== c.id))} style={{ background: 'none', border: 'none', color: colors.red, cursor: 'pointer', fontSize: '13px', padding: '2px' }}>✕</button>
                        </td>
                      </tr>
                    );
                  })}
            ...
            <div style={{ border: `2px dashed ${colors.br}`, borderRadius: '10px', padding: '32px', textAlign: 'center' }}>
              ...
              <div style={{ fontSize: '11px', color: colors.t3, marginTop: '4px' }}>Haz clic en "Registrar publicación" para empezar a trackear tu contenido</div>
            </div>
          )}
        </div>

        {/* ═══ REGISTRO DE COLABORACIONES / INFLUENCERS ═══ */}
        <div style={{ ...cardStyle, marginTop: '12px', borderLeft: `3px solid ${colors.gold}` }}>
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '16px' }}>
            <div>
              ...
              <div style={{ fontSize: '12px', color: colors.t2 }}>Registra envíos, canjes y colaboraciones pagadas</div>
            </div>
            <button onClick={() => setShowFormCollab(!showFormCollab)} style={buttonStyle('gold')}>{showFormCollab ? '✕ Cerrar' : '+ Nueva colaboración'}</button>
          </div>
          {showFormCollab && (
            <div style={{ background: colors.bg1, borderRadius: '10px', border: `1px solid ${colors.br}`, padding: '16px', marginBottom: '16px' }}>
              <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr 1fr 1fr', gap: '10px', marginBottom: '10px' }}>
              ...
              <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr 1fr 2fr', gap: '10px', marginBottom: '12px' }}>
                ...
                <div>
                  ...
                  <select value={newCollab.estado} onChange={e => setNewCollab({ ...newCollab, estado: e.target.value })} style={{ width: '100%', background: colors.bg3, border: `1px solid ${colors.br}`, borderRadius: '6px', padding: '8px', color: colors.t1, fontSize: '12px' }}>
                    {['Enviado', 'Publicado', 'En negociación', 'Completado', 'Cancelado'].map(e => <option key={e} value={e}>{e}</option>)}
                  </select>
                </div>
                <div>
                  <label style={{ fontSize: '10px', color: colors.t2, display: 'block', marginBottom: '4px' }}>Notas</label>
                  <input value={newCollab.notas} onChange={e => setNewCollab({ ...newCollab, notas: e.target.value })} placeholder="Detalles de la colaboración..." style={{ width: '100%', background: colors.bg3, border: `1px solid ${colors.br}`, borderRadius: '6px', padding: '8px', color: colors.t1, fontSize: '12px' }} />
                </div>
              </div>
          ...
          {collabs.length > 0 ? (
            <>
              <div style={{ display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: '10px', marginBottom: '16px' }}>
                ...
                <div style={{ background: 'rgba(0,200,224,0.06)', border: '1px solid rgba(0,200,224,0.15)', borderRadius: '8px', padding: '12px', textAlign: 'center' }}>
                  ...
                  <div style={{ fontSize: '18px', fontWeight: '700', color: colors.t1 }}>{(() => { const inv = collabs.reduce((a, c) => a + c.costo, 0); const ven = collabs.reduce((a, c) => a + c.ventasGeneradas, 0); return inv > 0 ? (ven / inv).toFixed(1) + 'x' : '—'; })()}</div>
                </div>
              </div>
              <div style={{ overflowX: 'auto' }}>
                <table style={tableStyle}>
                  ...
                  <tbody>
                    {collabs.map((c) => {
                      const estadoMap = { 'Enviado': colors.blue, 'Publicado': colors.green, 'En negociación': colors.gold, 'Completado': colors.cyan, 'Cancelado': colors.red };
                      return (
                        <tr key={c.id}>
                          ...
                          <td style={{ ...tdStyle, textAlign: 'right' }}>{c.ventasGeneradas > 0 ? formatMXN(c.ventasGeneradas) : '—'}</td>
                          ...
                          <td style={{ ...tdStyle, fontSize: '11px', color: colors.t2 }}>{c.notas || '—'}</td>
                        </tr>
                      );
                    })}
                  </tbody>
            ...
            <div style={{ border: `2px dashed ${colors.br}`, borderRadius: '10px', padding: '32px', textAlign: 'center' }}>
              ...
              <div style={{ fontSize: '11px', color: colors.t3, marginTop: '4px' }}>Cuando hagas envíos a influencers o canjes, regístralos aquí para medir el ROI</div>
            </div>
          )}
        </div>
        ...
        {!metaConnected && (
          <div style={{ ...cardStyle, marginTop: '12px', background: 'rgba(255,255,255,0.02)', borderColor: 'rgba(255,255,255,0.07)' }}>
            <h4 style={{ fontSize: '10px', fontWeight: '700', letterSpacing: '0.1em', textTransform: 'uppercase', color: colors.t2, marginBottom: '14px', display: 'flex', alignItems: 'center' }}>
              <span style={{ color: colors.cyan, marginRight: '8px' }}>—</span>Cómo conectar Meta Business Suite
            </h4>
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr 1fr 1fr', gap: '10px' }}>
              {[
                { paso: '1', titulo: 'Meta Business Suite', desc: 'Accede a business.facebook.com y verifica que tu cuenta de negocio esté activa.' },
                { paso: '2', titulo: 'Crear App en Meta', desc: 'Ve a developers.facebook.com → Mis Apps → Crear App tipo "Business".' },
                { paso: '3', titulo: 'Permisos de API', desc: 'Activa Marketing API y genera un token de acceso con permisos ads_read.' },
                { paso: '4', titulo: 'Conectar aquí', desc: 'Ingresa tu App ID y token — todas las métricas se actualizarán automáticamente.' },
              ].map((p, idx) => (
  ...
  const ObjetivosSection = () => {
    ...
    // ── Escenario CONSERVADOR: +15% vs 2025 ──
    ...
    // ── Escenario AMBICIOSO: +35% vs 2025 ──
    ...
    // Distribución mensual proporcional a 2025
    ...
    // Déficit y redistribución conservador
    let deficitCons = 0;
    ...
    // Déficit y redistribución ambicioso
    let deficitAmb = 0;
    ...
    return (
      <div>
        ...
        <div style={{ display: 'flex', gap: '8px', marginBottom: '12px' }}>
          {[
            { id: 'conservador', label: 'Conservador · +15%', color: colors.cyan, desc: `Meta: ${formatMXN(metaVentasCons)}` },
            { id: 'ambicioso', label: 'Ambicioso · +35%', color: colors.gold, desc: `Meta: ${formatMXN(metaVentasAmb)}` },
          ].map(e => (
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: '10px', marginBottom: '12px' }}>
          ...
          <StatCard label="Utilidad proyectada" value={formatMXN(metaUtilidad)} note="Después de gastos fijos" color={colors.green} />
          <StatCard label="Utilidad YTD real" value={formatMXN(utilidadYTD)} note={utilidadYTD >= 0 ? 'Positiva' : 'En déficit'} color={utilidadYTD >= 0 ? colors.green : colors.red} />
        ...
        <div style={cardStyle}>
          <h4 style={{ fontSize: '10px', fontWeight: '700', letterSpacing: '0.1em', textTransform: 'uppercase', color: colors.t2, marginBottom: '16px', display: 'flex', alignItems: 'center' }}>
            <span style={{ color: colors.cyan, marginRight: '8px' }}>—</span>Comparativo de escenarios
          </h4>
        ...
        {/* ═══ PROGRESO DEL ESCENARIO ACTIVO ═══ */}
        <div style={{ ...cardStyle, marginTop: '12px' }}>
          <h4 style={{ fontSize: '10px', fontWeight: '700', letterSpacing: '0.1em', textTransform: 'uppercase', color: colors.t2, marginBottom: '16px', display: 'flex', alignItems: 'center' }}>
            <span style={{ color: esAmb ? colors.gold : colors.cyan, marginRight: '8px' }}>—</span>Progreso · {esAmb ? 'Ambicioso' : 'Conservador'} · {formatMXN(metaVentas)}
          </h4>
            ...
            {MESES.slice(0, 6).map((m, idx) => {
              ...
              return (
                <div key={idx} style={{ background: esPasado ? 'rgba(255,255,255,0.02)' : colors.bg3, border: `1px solid ${esActual ? acColor + '50' : colors.br}`, borderRadius: '8px', padding: '12px', textAlign: 'center', opacity: esPasado ? 0.7 : 1 }}>
                  <div style={{ fontSize: '10px', fontWeight: '700', textTransform: 'uppercase', color: esActual ? acColor : colors.t2, marginBottom: '6px' }}>{m} {esActual && '●'}</div>
                  {esPasado ? (
                    <>
                      <div style={{ fontSize: '14px', fontWeight: '700', color: pct >= 100 ? colors.green : colors.red, marginBottom: '2px' }}>{formatMXN(cumplido)}</div>
                      <div style={{ fontSize: '10px', color: pct >= 100 ? colors.green : colors.t3 }}>{pct}% {pct >= 100 ? '✓' : ''}</div>
                    </>
                  ) : esActual ? (
                    <>
          ...
          {deficit > 0 && (
            <div style={{ marginTop: '12px', padding: '10px 14px', background: (esAmb ? colors.gold : colors.cyan) + '08', border: `1px solid ${(esAmb ? colors.gold : colors.cyan)}20`, borderRadius: '8px', display: 'flex', justifyContent: 'space-between', alignItems: 'center', fontSize: '11px' }}>
              <span style={{ color: colors.t2 }}>Déficit acumulado: <span style={{ color: colors.red, fontWeight: '600' }}>{formatMXN(deficit)}</span></span>
        ...
        <div style={{ ...cardStyle, marginTop: '12px' }}>
          <h4 style={{ fontSize: '10px', fontWeight: '700', letterSpacing: '0.1em', textTransform: 'uppercase', color: colors.t2, marginBottom: '16px', display: 'flex', alignItems: 'center' }}>
            <span style={{ color: colors.green, marginRight: '8px' }}>—</span>Utilidad · Margen {(MARGEN * 100).toFixed(1)}% − {formatMXN(totalGastosFijos)} gastos fijos/mes
          </h4>
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: '10px', marginBottom: '16px' }}>
            ...
            <div style={{ background: 'rgba(0,200,224,0.06)', border: '1px solid rgba(0,200,224,0.15)', borderRadius: '8px', padding: '14px', textAlign: 'center' }}>
              ...
              <div style={{ fontSize: '10px', color: colors.t3, marginTop: '2px' }}>venta mínima/mes para $0</div>
            </div>
            ...
            {MESES.slice(0, 6).map((m, idx) => {
              ...
              return (
                <div key={idx} style={{ background: esPasado ? 'rgba(255,255,255,0.02)' : colors.bg3, border: `1px solid ${esActual ? 'rgba(34,197,94,0.3)' : colors.br}`, borderRadius: '8px', padding: '10px', textAlign: 'center', opacity: (!tieneData && !esActual) ? 0.4 : (esPasado ? 0.7 : 1) }}>
                  ...
                  <div style={{ fontSize: '14px', fontWeight: '700', color: tieneData ? (util >= 0 ? colors.green : colors.red) : colors.t3 }}>{tieneData ? formatMXN(util) : '—'}</div>
                </div>
              );
            })}
          </div>
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(6, 1fr)', gap: '8px', marginTop: '8px' }}>
            {MESES.slice(6, 12).map((m, idx) => (
              <div key={idx + 6} style={{ background: colors.bg3, border: `1px solid ${colors.br}`, borderRadius: '8px', padding: '10px', textAlign: 'center', opacity: 0.4 }}>
                ...
                <div style={{ fontSize: '14px', fontWeight: '700', color: colors.t3 }}>—</div>
              </div>
            ))}
          </div>
        </div>
        ...
        <div style={{ ...cardStyle, marginTop: '12px', borderLeft: `3px solid ${colors.red}` }}>
          <div style={{ marginBottom: '16px' }}>
            ...
            <div style={{ fontSize: '12px', color: colors.t2 }}>Planea tus gastos proyectados — ajusta los montos si planeas crecer el equipo, cambiar de local o invertir más</div>
          </div>
          {(() => {
              ...
              <>
                ...
                <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '12px', marginBottom: '16px' }}>
                  ...
                  <div style={{ padding: '16px', background: (esAmb ? colors.gold : colors.cyan) + '06', borderRadius: '10px', border: `1px solid ${(esAmb ? colors.gold : colors.cyan)}20` }}>
                    <div style={{ fontSize: '10px', fontWeight: '700', letterSpacing: '0.1em', textTransform: 'uppercase', color: esAmb ? colors.gold : colors.cyan, marginBottom: '14px' }}>Gastos proyectados — editable</div>
                    <div style={{ marginBottom: '10px' }}>
                      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '4px' }}>
                        <label style={{ fontSize: '11px', color: colors.t2 }}>Fijos / mes</label>
                        <span style={{ fontSize: '9px', color: colors.t3 }}>Renta, nómina, servicios, herramientas</span>
                      </div>
                    ...
                    <div style={{ marginBottom: '10px' }}>
                      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '4px' }}>
                        ...
                        <span style={{ fontSize: '9px', color: colors.t3 }}>Ads, comisiones, envíos, etc.</span>
                      </div>
                ...
                <div style={{ padding: '14px 16px', background: 'rgba(255,255,255,0.02)', borderRadius: '10px', border: `1px solid ${colors.br}`, marginBottom: '16px' }}>
                  <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '10px' }}>
                    <div>
                      <div style={{ fontSize: '12px', fontWeight: '600', color: colors.t1 }}>Tope máximo de gastos</div>
                      <div style={{ fontSize: '11px', color: colors.t3 }}>Porcentaje máximo de gastos sobre ventas</div>
                    </div>
                ...
                <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: '10px', marginBottom: '16px' }}>
                  ...
                  <div style={{ background: diferenciaUtilidad > 0 ? 'rgba(239,68,68,0.06)' : 'rgba(34,197,94,0.06)', border: `1px solid ${diferenciaUtilidad > 0 ? 'rgba(239,68,68,0.15)' : 'rgba(34,197,94,0.15)'}`, borderRadius: '8px', padding: '14px', textAlign: 'center' }}>
                    ...
                    <div style={{ fontSize: '10px', color: colors.t3, marginTop: '2px' }}>{diferenciaUtilidad > 0 ? 'menos utilidad anual' : 'más utilidad anual'}</div>
                  </div>
                </div>

                {/* Ejemplos de escenarios */}
                <div style={{ fontSize: '10px', fontWeight: '700', letterSpacing: '0.1em', textTransform: 'uppercase', color: colors.t2, marginBottom: '10px' }}>Escenarios comunes — haz clic para cargar</div>
                <div style={{ display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: '8px', marginBottom: '16px' }}>
                  {[
                    { label: 'Actual', fijos: gastosFijosReales, variable: gastosVarMesReal, desc: 'Sin cambios', icon: '📌' },
                    { label: '+1 empleado', fijos: gastosFijosReales + 10000, variable: gastosVarMesReal, desc: '+$10K nómina', icon: '👤' },
                    { label: 'Escalar ads', fijos: gastosFijosReales, variable: gastosVarMesReal + 8000, desc: '+$8K en ads', icon: '📈' },
                    { label: 'Crecer todo', fijos: gastosFijosReales + 15000, variable: gastosVarMesReal + 10000, desc: '+equipo +ads', icon: '🚀' },
                  ].map((esc, idx) => (
                ...
                <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: '10px' }}>
                  {[
                    { icon: '🎯', titulo: 'Regla del tope', desc: `Mantén los gastos totales por debajo del ${metaPctTope}% de tus ventas. Si vendes ${formatMXN(porMes)}/mes, tu tope es ${formatMXN(Math.round(porMes * metaPctTope / 100))}.`, color: colors.cyan },
                    { icon: '📉', titulo: 'Variables: revisar cada mes', desc: 'Si el ROAS de ads baja de 2x, pausa y optimiza. Si Clip cobra mucho, evalúa Stripe o transferencia directa.', color: colors.orange },
                    { icon: '🔒', titulo: 'Fijos: negociar anualmente', desc: 'Renta, servicios y herramientas se negocian 1 vez al año. Busca descuentos anuales y renegocia contratos.', color: colors.red },
                  ].map((t, idx) => (
                    <div key={idx} style={{ padding: '14px', background: colors.bg1, borderRadius: '10px', border: `1px solid ${colors.br}` }}>
        ...
        <div style={{ ...cardStyle, marginTop: '12px', borderLeft: `3px solid ${colors.green}` }}>
          <div style={{ marginBottom: '16px' }}>
            <h3 style={{ fontSize: '16px', fontWeight: '700', marginBottom: '4px' }}>¿Cómo lograrlo?</h3>
            <div style={{ fontSize: '12px', color: colors.t2 }}>Acciones concretas para alcanzar el escenario {esAmb ? 'ambicioso' : 'conservador'}</div>
          </div>
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(2, 1fr)', gap: '10px' }}>
            {(esAmb ? [
              { icon: '🚀', titulo: 'Escalar inversión en ads', desc: `Necesitas vender ${formatMXN(porMesAmb)}/mes. Invierte al menos ${formatMXN(Math.round(porMesAmb / 3.5))} en Meta Ads (asumiendo ROAS 3.5x) para generar tráfico suficiente.`, prioridad: 'Alta' },
              { icon: '📦', titulo: 'Ampliar catálogo y stock', desc: 'Aprovecha todas las temporadas de descuento (Farfetch, SSENSE, Cettire) para comprar inventario a mejor precio y tener variedad.', prioridad: 'Alta' },
              { icon: '🎯', titulo: 'Lanzar programa de referidos', desc: 'Ofrece un 5-10% de descuento por referido. Tus clientes satisfechos son tu mejor canal de adquisición gratuito.', prioridad: 'Media' },
              { icon: '📱', titulo: 'Contenido 5x por semana', desc: 'Sube a 5 publicaciones semanales combinando Reels de entretenimiento + producto. Más contenido = más alcance = más ventas.', prioridad: 'Alta' },
              { icon: '🤝', titulo: 'Colaboraciones con influencers', desc: 'Invierte en 2-3 micro-influencers al mes (5K-20K seguidores). El ROI en streetwear suele ser alto por la comunidad.', prioridad: 'Media' },
              { icon: '💰', titulo: 'Subir ticket promedio', desc: 'Introduce bundles (par + accesorios), upselling en checkout, y piezas de mayor valor (Amiri, Golden Goose) para subir el AOV.', prioridad: 'Media' },
            ] : [
              { icon: '📈', titulo: 'Mantener inversión en ads', desc: `Con ${formatMXN(porMesCons)}/mes de meta, invierte al menos ${formatMXN(Math.round(porMesCons / 3.5))} en Meta Ads para mantener el flujo de tráfico actual.`, prioridad: 'Alta' },
              { icon: '📦', titulo: 'Reposición constante', desc: 'No dejes que se agoten los productos estrella. Haz pedidos de reposición cada 2-3 semanas para no perder ventas.', prioridad: 'Alta' },
              { icon: '📱', titulo: 'Contenido consistente', desc: 'Mantén 3-4 publicaciones por semana. La consistencia importa más que la cantidad. Sigue con lo que funciona: Reels + humor.', prioridad: 'Media' },
              { icon: '⭐', titulo: 'Fidelizar clientes actuales', desc: 'Envía WhatsApp cuando llegue producto nuevo, ofrece acceso anticipado a clientes recurrentes. Retener es más barato que adquirir.', prioridad: 'Alta' },
              { icon: '📊', titulo: 'Optimizar margen', desc: `Tu margen actual es ${(MARGEN * 100).toFixed(1)}%. Busca proveedores con mejores precios o sube precios en piezas exclusivas para mejorar 2-3 puntos.`, prioridad: 'Media' },
              { icon: '🏪', titulo: 'Fortalecer tienda física', desc: 'La tienda física genera confianza. Mejora la experiencia en tienda y úsala como contenido para redes.', prioridad: 'Media' },
            ]).map((r, idx) => (
  ...
  const ForecastSection = () => {
    ...
    // Meses pasados: usar dato real; futuros: proyección
    ...
    return (
      <div>
        <SectionTitle sub="Proyección financiera + inteligencia de producto">Forecast</SectionTitle>

        {/* ═══ SLIDER DE CRECIMIENTO ═══ */}
        <div style={{ ...cardStyle, marginBottom: '12px', borderLeft: `3px solid ${colors.cyan}` }}>
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '12px' }}>
            <div>
              <h3 style={{ fontSize: '16px', fontWeight: '700', marginBottom: '2px' }}>Proyección de crecimiento</h3>
              <div style={{ fontSize: '12px', color: colors.t2 }}>Basada en la estacionalidad de 2025 ({formatMXN(ventas2025Total)}) — ajusta el % de crecimiento</div>
            </div>
            <div style={{ textAlign: 'right' }}>
        ...
        <div style={cardStyle}>
          <h4 style={{ fontSize: '10px', fontWeight: '700', letterSpacing: '0.1em', textTransform: 'uppercase', color: colors.t2, marginBottom: '16px', display: 'flex', alignItems: 'center' }}>
            <span style={{ color: colors.cyan, marginRight: '8px' }}>—</span>Proyección mensual 2026 · {formatMXN(totalProyectado26)}
          </h4>
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(6, 1fr)', gap: '8px' }}>
            {ventasProyectadas26.slice(0, 6).map((v, idx) => {
              ...
              return (
                <div key={idx} style={{ background: v.esPasado ? 'rgba(255,255,255,0.02)' : colors.bg3, border: `1px solid ${esActual ? 'rgba(0,200,224,0.3)' : colors.br}`, borderRadius: '8px', padding: '10px', textAlign: 'center', opacity: v.esPasado ? 0.7 : 1 }}>
                  <div style={{ fontSize: '10px', fontWeight: '700', textTransform: 'uppercase', color: esActual ? colors.cyan : colors.t2, marginBottom: '4px' }}>{v.mes} {esActual && '●'}</div>
                  {v.esPasado ? (
                    <>
        ...
        <div style={{ ...cardStyle, marginTop: '12px' }}>
          <h4 style={{ fontSize: '10px', fontWeight: '700', letterSpacing: '0.1em', textTransform: 'uppercase', color: colors.t2, marginBottom: '16px', display: 'flex', alignItems: 'center' }}>
            <span style={{ color: colors.green, marginRight: '8px' }}>—</span>Flujo de caja proyectado · Margen bruto − Gastos operativos
          </h4>
        ...
        <div style={{ ...cardStyle, marginTop: '12px', borderLeft: `3px solid ${colors.orange}` }}>
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: '16px' }}>
            <div>
              <h3 style={{ fontSize: '16px', fontWeight: '700', marginBottom: '4px' }}>Análisis de costos de adquisición</h3>
              <div style={{ fontSize: '12px', color: colors.t2 }}>Haz clic en una fila para ver los productos — identifica dónde ganas más</div>
            </div>
            {/* Toggle marca / categoría */}
            <div style={{ display: 'flex', background: colors.bg1, borderRadius: '8px', border: `1px solid ${colors.br}`, overflow: 'hidden' }}>
              {[{ id: 'marca', label: 'Por marca' }, { id: 'categoria', label: 'Por categoría' }].map(v => (
                ...
                return (
                  <div key={marca} style={{ marginBottom: '8px' }}>
                    ...
                    <div onClick={() => setExpandedBrand(isOpen ? null : marca)} style={{ display: 'grid', gridTemplateColumns: '24px 1fr repeat(5, auto)', gap: '12px', alignItems: 'center', padding: '12px 14px', background: isOpen ? colors.bg1 : 'rgba(255,255,255,0.02)', borderRadius: isOpen ? '10px 10px 0 0' : '10px', border: `1px solid ${isOpen ? colors.orange + '30' : colors.br}`, cursor: 'pointer', transition: 'all 0.2s' }}>
                      <span style={{ fontSize: '14px', color: colors.orange, transition: 'transform 0.2s', transform: isOpen ? 'rotate(90deg)' : 'rotate(0deg)' }}>▶</span>
                      <div>
          ...
          {costView === 'categoria' && (() => {
            ...
            const catIcons = { tenis: '👟', ropa: '👕', accesorios: '🎒' };
                  ...
                  return (
                    <div key={cat} style={{ marginBottom: '8px' }}>
                      <div onClick={() => setExpandedCat(isOpen ? null : cat)} style={{ display: 'grid', gridTemplateColumns: '36px 1fr repeat(4, auto)', gap: '12px', alignItems: 'center', padding: '14px 14px', background: isOpen ? colors.bg1 : 'rgba(255,255,255,0.02)', borderRadius: isOpen ? '10px 10px 0 0' : '10px', border: `1px solid ${isOpen ? colors.purple + '30' : colors.br}`, cursor: 'pointer', transition: 'all 0.2s' }}>
                        <span style={{ fontSize: '24px' }}>{catIcons[cat] || '📦'}</span>
                        <div>
                          <span style={{ fontSize: '14px', fontWeight: '700', color: colors.t1 }}>{catLabels[cat] || cat}</span>
                          <span style={{ fontSize: '10px', color: colors.t3, marginLeft: '8px' }}>{data.productos} productos · {pctCat}% del total</span>
                        </div>
                        <div style={{ textAlign: 'right' }}>
                          <div style={{ fontSize: '10px', color: colors.t3 }}>Ventas</div>
                        ...
                        <span style={{ fontSize: '14px', color: colors.purple, transition: 'transform 0.2s', transform: isOpen ? 'rotate(90deg)' : 'rotate(0deg)' }}>▶</span>
                      </div>
                      {isOpen && (
                        <div style={{ background: colors.bg1, borderRadius: '0 0 10px 10px', border: `1px solid ${colors.purple}30`, borderTop: 'none', padding: '12px 14px' }}>
                          ...
                          <div style={{ display: 'flex', gap: '4px', height: '6px', borderRadius: '3px', overflow: 'hidden', marginBottom: '14px' }}>
                            {productos.map((p, pi) => {
                              ...
                              return <div key={pi} style={{ width: w + '%', background: pColors[pi % pColors.length], borderRadius: '3px' }} title={p.nombre + ' — ' + w.toFixed(1) + '%'} />;
                            })}
                          </div>
                          {productos.map((p, pi) => {
                            const ganUd = p.precio - p.costo;
                            ...
                            return (
                              <div key={pi} style={{ display: 'grid', gridTemplateColumns: '4px 2fr 1fr repeat(5, 1fr)', gap: '8px', padding: '8px 0', borderBottom: pi < productos.length - 1 ? `1px solid ${colors.br}` : 'none', alignItems: 'center' }}>
                                ...
                                <div>
                                  ...
                                  <div style={{ fontSize: '10px', color: colors.t3 }}>{p.marca} · {pctProd}% de la categoría</div>
                                </div>
                                <span style={{ fontSize: '12px', color: colors.t1, textAlign: 'right' }}>{formatMXN(p.precio)}</span>
                                <span style={{ fontSize: '12px', color: colors.t3, textAlign: 'right' }}>{formatMXN(p.costo)}</span>
                                <span style={{ fontSize: '12px', color: colors.green, textAlign: 'right' }}>{formatMXN(ganUd)}</span>
          ...
          <div style={{ marginTop: '16px' }}>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: '10px' }}>
              {(() => {
                ...
                const highlights = [
                  { label: 'Más rentable', icon: '💰', product: bestRevenue, stat: formatMXN((bestRevenue.precio - bestRevenue.costo) * bestRevenue.uds) + ' ganancia total', color: colors.gold },
                  { label: 'Mayor margen', icon: '📈', product: bestMargin, stat: (((bestMargin.precio - bestMargin.costo) / bestMargin.precio) * 100).toFixed(1) + '% margen unitario', color: colors.green },
                  { label: 'Más vendido', icon: '🔥', product: bestVolume, stat: bestVolume.uds + ' unidades vendidas', color: colors.red },
                ];
                return highlights.map((h, hi) => (
                  <div key={hi} style={{ padding: '16px', background: colors.bg1, borderRadius: '10px', border: `1px solid ${colors.br}`, position: 'relative', overflow: 'hidden' }}>
                    ...
                    <div style={{ fontSize: '11px', color: colors.t3, marginBottom: '8px' }}>{h.product.marca} · {h.product.cat}</div>
                ...
                {CATALOG.filter(p => ((p.precio - p.costo) / p.precio) < 0.40).map((p, pi) => {
                  ...
                  return (
                    <div key={pi} style={{ display: 'flex', alignItems: 'center', gap: '8px', padding: '6px 10px', background: colors.bg2, borderRadius: '6px', border: `1px solid ${colors.br}` }}>
                      ...
                      <span style={{ fontSize: '10px', color: colors.t3 }}>→ buscar mejor precio o subir venta</span>
                    </div>
                  );
                })}
                {CATALOG.filter(p => ((p.precio - p.costo) / p.precio) < 0.40).length === 0 && (
                  <span style={{ fontSize: '11px', color: colors.green }}>Todos los productos tienen margen superior al 40% — excelente</span>
                )}
              </div>
            </div>
          </div>
        ...
        {needRestock.length > 0 && (
          <div style={{ display: 'flex', gap: '12px', padding: '14px 16px', borderRadius: '10px', fontSize: '13px', lineHeight: '1.6', marginTop: '12px', background: 'rgba(239,68,68,0.08)', color: '#ff7b73', border: '1px solid rgba(239,68,68,0.2)' }}>
            <span>⚠️</span>
            <span>Hay <strong>{needRestock.length} productos</strong> con stock crítico (≤2 uds). Inversión estimada para reposición: <strong>{formatMXN(totalInversion)}</strong>.</span>
          </div>
        )}

        <div style={{ ...cardStyle, marginTop: '12px' }}>
          <h4 style={{ fontSize: '10px', fontWeight: '700', letterSpacing: '0.1em', textTransform: 'uppercase', color: colors.t2, marginBottom: '14px', display: 'flex', alignItems: 'center' }}>
            <span style={{ color: colors.red, marginRight: '8px' }}>—</span>Reposición urgente — {needRestock.length} productos
          </h4>
          <div style={{ overflowX: 'auto' }}>
            <table style={tableStyle}>
              <thead>
                <tr>
                  ...
                  <th style={{ ...thStyle, textAlign: 'right' }}>Inversión</th>
              ...
              <tbody>
                ...
                <tr style={{ borderTop: '1px solid rgba(255,255,255,0.1)' }}>
                  <td colSpan="6" style={{ ...tdStyle, fontWeight: '600', letterSpacing: '0.08em', textTransform: 'uppercase', fontSize: '11px' }}>Total inversión reposición</td>
        ...
        <div style={{ ...cardStyle, marginTop: '12px' }}>
          <h4 style={{ fontSize: '10px', fontWeight: '700', letterSpacing: '0.1em', textTransform: 'uppercase', color: colors.t2, marginBottom: '14px', display: 'flex', alignItems: 'center' }}>
            <span style={{ color: colors.gold, marginRight: '8px' }}>—</span>Ranking de marcas — Dónde invertir
          </h4>
        ...
        {/* ═══ VISTA PRELIMINAR 2027 ═══ */}
        <div style={{ ...cardStyle, marginTop: '12px', borderLeft: `3px solid ${colors.gold}` }}>
          <div style={{ marginBottom: '16px' }}>
            <h3 style={{ fontSize: '16px', fontWeight: '700', marginBottom: '4px' }}>Vista preliminar 2027</h3>
            <div style={{ fontSize: '12px', color: colors.t2 }}>Proyección con el mismo +{pctCrecimiento}% de crecimiento sostenido — {formatMXN(meta27)} en ventas</div>
          </div>
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: '10px', marginBottom: '16px' }}>
            <div style={{ background: 'rgba(240,180,41,0.06)', border: '1px solid rgba(240,180,41,0.15)', borderRadius: '8px', padding: '12px', textAlign: 'center' }}>
              <div style={{ fontSize: '9px', fontWeight: '700', letterSpacing: '0.1em', textTransform: 'uppercase', color: colors.gold, marginBottom: '4px' }}>Ventas 2027</div>
          ...
          <div style={{ marginTop: '12px', padding: '10px 14px', background: 'rgba(255,255,255,0.02)', borderRadius: '8px', border: `1px solid ${colors.br}`, fontSize: '11px', color: colors.t2, textAlign: 'center' }}>
            2025: {formatMXN(ventas2025Total)} → 2026: {formatMXN(totalProyectado26)} (+{pctCrecimiento}%) → 2027: {formatMXN(meta27)} (+{pctCrecimiento}%)
          </div>
        </div>
            ...
            <div style={{ ...cardStyle, marginTop: '12px', borderLeft: `3px solid ${colors.teal}` }}>
              <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: '16px' }}>
                <div>
                  ...
                  <div style={{ fontSize: '12px', color: colors.t2 }}>Ventas mínimas necesarias para cubrir todos los costos operativos</div>
                </div>
                <div style={{ textAlign: 'right' }}>
              ...
              <div style={{ display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: '10px', marginBottom: '16px' }}>
                <div style={{ background: colors.bg1, borderRadius: '8px', border: `1px solid ${colors.br}`, padding: '12px', textAlign: 'center' }}>
                  ...
                  <div style={{ fontSize: '10px', color: colors.t3 }}>por día</div>
                </div>
                <div style={{ background: colors.bg1, borderRadius: '8px', border: `1px solid ${colors.br}`, padding: '12px', textAlign: 'center' }}>
        ...
        {(() => {
          const escenarios = [
            { label: 'Base', pct: 0, color: colors.cyan, icon: '📊' },
            { label: 'Caída -10%', pct: -10, color: colors.gold, icon: '⚡' },
            { label: 'Caída -20%', pct: -20, color: colors.orange, icon: '🔻' },
            { label: 'Caída -30%', pct: -30, color: colors.red, icon: '🚨' },
          ];
          return (
            <div style={{ ...cardStyle, marginTop: '12px', borderLeft: `3px solid ${colors.red}` }}>
              <div style={{ marginBottom: '16px' }}>
                <h3 style={{ fontSize: '16px', fontWeight: '700', marginBottom: '4px' }}>Escenarios de riesgo</h3>
                <div style={{ fontSize: '12px', color: colors.t2 }}>¿Qué pasa si las ventas bajan? Impacto en utilidad y flujo de caja</div>
              </div>
              <div style={{ display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: '10px', marginBottom: '16px' }}>
                {escenarios.map((esc, ei) => {
                  ...
                  return (
                    <div key={ei} style={{ background: colors.bg1, borderRadius: '10px', border: `1px solid ${esc.color}25`, padding: '16px', position: 'relative', overflow: 'hidden' }}>
                      ...
                      <div style={{ fontSize: '10px', color: colors.t3, marginBottom: '12px' }}>{esc.pct === 0 ? 'Proyección actual' : `${esc.pct}% en ventas`}</div>
                ...
                return (
                  <div style={{ padding: '14px 16px', background: 'rgba(255,255,255,0.02)', borderRadius: '10px', border: `1px solid ${colors.br}` }}>
                    <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '8px' }}>
                      ...
                      <span style={{ fontSize: '12px', fontWeight: '700', color: colchon }}>Soporta hasta -{maxDrop}% de caída</span>
                    </div>
        ...
        {/* ═══ ESTACIONALIDAD — MAPA DE CALOR 2025 vs 2026 ═══ */}
        {(() => {
            ...
            <div style={{ ...cardStyle, marginTop: '12px', borderLeft: `3px solid ${colors.blue}` }}>
              <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: '16px' }}>
                <div>
                  ...
                  <div style={{ fontSize: '12px', color: colors.t2 }}>Mapa de calor comparativo — patrones de venta 2025 vs 2026</div>
                </div>
        ...
        {(() => {
          ...
          return (
            <div style={{ ...cardStyle, marginTop: '12px', borderLeft: `3px solid ${colors.purple}` }}>
              <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: '16px' }}>
                <div>
                  <h3 style={{ fontSize: '16px', fontWeight: '700', marginBottom: '4px' }}>Métricas por canal</h3>
                  <div style={{ fontSize: '12px', color: colors.t2 }}>Shopify online vs Tienda física — ajusta el split para proyectar</div>
                </div>
              </div>
              ...
              <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '12px' }}>
                ...
                <div style={{ background: 'rgba(168,85,247,0.06)', borderRadius: '10px', border: '1px solid rgba(168,85,247,0.15)', padding: '16px' }}>
                  ...
                  <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '8px' }}>
                    ...
                    <div><div style={{ fontSize: '9px', color: colors.t3, textTransform: 'uppercase', marginBottom: '2px' }}>Órdenes</div><div style={{ fontSize: '14px', fontWeight: '700', color: colors.t1 }}>{ordenesOnline.toLocaleString()}</div></div>
                ...
                <div style={{ background: 'rgba(0,200,224,0.06)', borderRadius: '10px', border: '1px solid rgba(0,200,224,0.15)', padding: '16px' }}>
                  <div style={{ display: 'flex', alignItems: 'center', gap: '8px', marginBottom: '12px' }}>
                    <span style={{ fontSize: '20px' }}>🏪</span>
                    <div>
                      <div style={{ fontSize: '13px', fontWeight: '700', color: colors.cyan }}>Tienda física</div>
                  ...
                  <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '8px' }}>
                    ...
                    <div><div style={{ fontSize: '9px', color: colors.t3, textTransform: 'uppercase', marginBottom: '2px' }}>Órdenes</div><div style={{ fontSize: '14px', fontWeight: '700', color: colors.t1 }}>{ordenesTienda.toLocaleString()}</div></div>
              ...
              <div style={{ marginTop: '12px', padding: '10px 14px', background: 'rgba(168,85,247,0.06)', borderRadius: '8px', border: '1px solid rgba(168,85,247,0.15)', fontSize: '11px', color: colors.t2, textAlign: 'center' }}>
                {parseFloat(margenNetoOnline) > parseFloat(margenNetoTienda)
                  ? `Online tiene mejor margen neto (${margenNetoOnline}% vs ${margenNetoTienda}%) — considera escalar el canal digital`
                  : `Tienda física tiene mejor margen neto (${margenNetoTienda}% vs ${margenNetoOnline}%) — la presencia física sigue siendo tu fortaleza`
                }
              </div>
            </div>
          );
        ...
        {/* ═══ ROI POR INVERSIÓN ═══ */}
        {(() => {
          const totalAdSpend = recurrentes.filter(g => g.concepto === 'Inversión Meta Ads').reduce((a, g) => a + g.monto, 0);
          const mesesConAds = new Set(recurrentes.filter(g => g.concepto === 'Inversión Meta Ads').map(g => g.mes)).size || 1;
          ...
          const inversiones = [
            { nombre: 'Meta Ads', icon: '📢', inversion: adSpendAnual, retorno: ventasPorAds, roi: parseFloat(roiAds), color: colors.blue, detalle: `ROAS ${roasEstimado}x · ${mesesConAds} meses con datos` },
            { nombre: 'Inventario', icon: '📦', inversion: valorInventarioCosto, retorno: valorInventarioVenta, roi: parseFloat(roiInventario), color: colors.gold, detalle: `${CATALOG.reduce((a, p) => a + p.stock, 0)} uds · Rotación ${rotacion}x` },
            { nombre: 'Equipo y mob.', icon: '🖥️', inversion: totalMobInv, retorno: beneficioEquipo, roi: parseFloat(roiEquipo), color: colors.purple, detalle: `Depreciación: ${formatMXN(depAnual)}/año (5 años)` },
          ];
          ...
          return (
            <div style={{ ...cardStyle, marginTop: '12px', borderLeft: `3px solid ${colors.green}` }}>
              <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: '16px' }}>
                <div>
                  <h3 style={{ fontSize: '16px', fontWeight: '700', marginBottom: '4px' }}>ROI por inversión</h3>
                  <div style={{ fontSize: '12px', color: colors.t2 }}>Retorno estimado de cada área de inversión del negocio</div>
                </div>
                <div style={{ textAlign: 'right' }}>
                ...
                {inversiones.map((inv, ii) => (
                  <div key={ii} style={{ background: colors.bg1, borderRadius: '10px', border: `1px solid ${inv.color}25`, padding: '16px', position: 'relative', overflow: 'hidden' }}>
                    ...
                    <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '8px', marginBottom: '10px' }}>
                      <div>
                        <div style={{ fontSize: '9px', color: colors.t3, textTransform: 'uppercase', marginBottom: '2px' }}>Inversión</div>
  ...
  const ActivosSection = () => {
    ...
    const CATEGORIAS_MOB = ['Mobiliario', 'Equipo', 'Decoración', 'Herramientas', 'Vehículo', 'Otro'];
    const UBICACIONES = ['Tienda', 'Bodega', 'Oficina', 'Casa', 'Otro'];
    const TIPOS_PASIVO = ['Préstamo', 'Tarjeta de crédito', 'Cuenta por pagar', 'Deuda proveedor', 'Otro'];
    ...
    return (
      <div>
        ...
        <div style={{ ...cardStyle, marginBottom: '12px', borderLeft: `3px solid ${colors.cyan}` }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr auto 1fr auto 1fr', gap: '12px', alignItems: 'center' }}>
            ...
            <div style={{ padding: '20px', background: 'rgba(0,200,224,0.06)', borderRadius: '12px', border: '1px solid rgba(0,200,224,0.15)', textAlign: 'center' }}>
              ...
              <div style={{ fontSize: '10px', color: colors.t3, marginTop: '6px' }}>Circulantes: {formatMXN(totalActivosCirculantes)} · Fijos: {formatMXN(totalActivosFijos)}</div>
            </div>
        ...
        <div style={cardStyle}>
          <h4 style={{ fontSize: '10px', fontWeight: '700', letterSpacing: '0.1em', textTransform: 'uppercase', color: colors.t2, marginBottom: '14px', display: 'flex', alignItems: 'center' }}>
            <span style={{ color: colors.green, marginRight: '8px' }}>—</span>Dinero disponible
          </h4>
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: '10px' }}>
            {[
              { label: 'Efectivo en caja', value: efectivoCaja, setter: setEfectivoCaja, color: colors.green, icon: '💵' },
              { label: 'Saldo en banco', value: saldoBanco, setter: setSaldoBanco, color: colors.blue, icon: '🏦' },
              { label: 'Cuentas por cobrar', value: cuentasPorCobrar, setter: setCuentasPorCobrar, color: colors.cyan, icon: '📋' },
            ].map((item, idx) => (
              <div key={idx} style={{ padding: '16px', background: colors.bg1, borderRadius: '10px', border: `1px solid ${colors.br}` }}>
                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '8px' }}>
        ...
        <div style={{ ...cardStyle, marginTop: '12px' }}>
          <h4 style={{ fontSize: '10px', fontWeight: '700', letterSpacing: '0.1em', textTransform: 'uppercase', color: colors.t2, marginBottom: '14px', display: 'flex', alignItems: 'center' }}>
            <span style={{ color: colors.gold, marginRight: '8px' }}>—</span>Inventario físico (producto para venta)
          </h4>
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: '10px', marginBottom: '16px' }}>
            <div style={{ background: 'rgba(240,180,41,0.06)', border: '1px solid rgba(240,180,41,0.15)', borderRadius: '8px', padding: '12px', textAlign: 'center' }}>
        ...
        <div style={{ ...cardStyle, marginTop: '12px' }}>
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '14px' }}>
            <h4 style={{ fontSize: '10px', fontWeight: '700', letterSpacing: '0.1em', textTransform: 'uppercase', color: colors.t2, marginBottom: '0', display: 'flex', alignItems: 'center' }}>
              <span style={{ color: colors.purple, marginRight: '8px' }}>—</span>Mobiliario y equipo · {formatMXN(totalMobiliario)}
            </h4>
            <button onClick={() => setShowFormMob(!showFormMob)} style={buttonStyle('purple')}>{showFormMob ? '✕ Cerrar' : '+ Agregar activo'}</button>
          </div>
          {showFormMob && (
            <div style={{ background: colors.bg1, borderRadius: '10px', border: `1px solid ${colors.br}`, padding: '16px', marginBottom: '16px' }}>
              <div style={{ display: 'grid', gridTemplateColumns: '2fr 1fr 1fr 1fr 1fr', gap: '10px', marginBottom: '12px' }}>
                <div>
                  ...
                  <input value={newMob.nombre} onChange={e => setNewMob({ ...newMob, nombre: e.target.value })} placeholder="Ej: Escritorio, Cámara..." style={{ width: '100%', background: colors.bg3, border: `1px solid ${colors.br}`, borderRadius: '6px', padding: '8px', color: colors.t1, fontSize: '12px' }} />
                </div>
                <div>
                  <label style={{ fontSize: '10px', color: colors.t2, display: 'block', marginBottom: '4px' }}>Categoría</label>
                ...
                <div>
                  <label style={{ fontSize: '10px', color: colors.t2, display: 'block', marginBottom: '4px' }}>Ubicación</label>
          ...
          {mobiliario.length > 0 ? (
            <div style={{ overflowX: 'auto' }}>
              <table style={tableStyle}>
                ...
                <tbody>
                  {mobiliario.map((m) => {
                    const catColors = { 'Mobiliario': colors.purple, 'Equipo': colors.cyan, 'Decoración': colors.pink, 'Herramientas': colors.orange, 'Vehículo': colors.blue, 'Otro': colors.t2 };
                    return (
                      <tr key={m.id}>
                        ...
                        <td style={{ ...tdStyle, textAlign: 'center' }}>
                          <button onClick={() => setMobiliario(prev => prev.filter(x => x.id !== m.id))} style={{ background: 'none', border: 'none', color: colors.red, cursor: 'pointer', fontSize: '13px' }}>✕</button>
                        </td>
                      </tr>
                    );
                  })}
        ...
        <div style={{ ...cardStyle, marginTop: '12px' }}>
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '14px' }}>
            <h4 style={{ fontSize: '10px', fontWeight: '700', letterSpacing: '0.1em', textTransform: 'uppercase', color: colors.t2, marginBottom: '0', display: 'flex', alignItems: 'center' }}>
              <span style={{ color: colors.red, marginRight: '8px' }}>—</span>Pasivos (deudas y obligaciones) · {formatMXN(totalPasivos)}
            </h4>
            <button onClick={() => setShowFormPasivo(!showFormPasivo)} style={buttonStyle('red')}>{showFormPasivo ? '✕ Cerrar' : '+ Registrar deuda'}</button>
          </div>
          {showFormPasivo && (
            <div style={{ background: colors.bg1, borderRadius: '10px', border: `1px solid ${colors.br}`, padding: '16px', marginBottom: '16px' }}>
              <div style={{ display: 'grid', gridTemplateColumns: '2fr 1fr 1fr 1fr', gap: '10px', marginBottom: '10px' }}>
                <div>
                  ...
                  <input value={newPasivo.concepto} onChange={e => setNewPasivo({ ...newPasivo, concepto: e.target.value })} placeholder="Ej: Préstamo bancario, TDC..." style={{ width: '100%', background: colors.bg3, border: `1px solid ${colors.br}`, borderRadius: '6px', padding: '8px', color: colors.t1, fontSize: '12px' }} />
                </div>
                <div>
              ...
              <button onClick={() => { if (newPasivo.concepto.trim() && newPasivo.monto) { setPasivos(prev => [...prev, { ...newPasivo, monto: Number(newPasivo.monto), montoPagado: Number(newPasivo.montoPagado) || 0, id: Date.now() }]); setNewPasivo({ concepto: '', tipo: 'Préstamo', monto: '', montoPagado: 0, acreedor: '', fechaInicio: '', fechaVence: '', notas: '' }); setShowFormPasivo(false); } }} style={{ ...buttonStyle('green'), width: '100%' }}>Registrar deuda</button>
            </div>
          )}
          {pasivos.length > 0 ? (
            <div style={{ overflowX: 'auto' }}>
                  ...
                  {pasivos.map((p) => {
                    ...
                    return (
                      <tr key={p.id}>
                        ...
                        <td style={{ ...tdStyle, textAlign: 'center' }}>
                          <button onClick={() => setPasivos(prev => prev.filter(x => x.id !== p.id))} style={{ background: 'none', border: 'none', color: colors.red, cursor: 'pointer', fontSize: '13px' }}>✕</button>
                        </td>
                      </tr>
                    );
                  })}
            ...
            <div style={{ border: `2px dashed ${colors.br}`, borderRadius: '10px', padding: '32px', textAlign: 'center' }}>
              ...
              <div style={{ fontSize: '11px', color: colors.t3, marginTop: '4px' }}>Si tienes préstamos, tarjetas o deudas con proveedores, regístralas aquí</div>
            </div>
          )}
        </div>
      </div>
    ...
    <div style={{ background: colors.bg, color: colors.t1, fontFamily: 'Inter, -apple-system, BlinkMacSystemFont, sans-serif', minHeight: '100vh' }}>
      ...
      {syncError && (
        <div style={{ position: 'fixed', top: '52px', left: 0, right: 0, zIndex: 99, padding: '8px 16px', background: 'rgba(239,68,68,0.12)', borderBottom: '1px solid rgba(239,68,68,0.25)', display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '8px', fontSize: '11px', color: '#ff8a80' }}>
          <AlertCircle size={14} />
          <span>{syncError}</span>
          <button onClick={() => setSyncError(null)} style={{ background: 'none', border: 'none', color: '#ff8a80', cursor: 'pointer', fontSize: '14px', padding: '0 4px' }}>×</button>
        </div>
      )}
      {dataSource === 'live' && !syncError && lastSync && (
        <div style={{ position: 'fixed', top: '52px', left: 0, right: 0, zIndex: 99, padding: '6px 16px', background: 'rgba(34,197,94,0.08)', borderBottom: '1px solid rgba(34,197,94,0.15)', display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '6px', fontSize: '10px', color: colors.green }}>
          <Wifi size={12} />
          <span>Conectado a Shopify ({STORE_DOMAIN}) · Última sync: {lastSync.toLocaleTimeString('es-MX')} · Auto-refresh cada 5 min</span>
        </div>
      )}
